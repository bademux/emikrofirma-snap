...
public interface ENC {
   ...
   String FLB = "profiles";
   String FLC = ".db";
   FDR FLD = (FDR)ENC.END.cell_technical_id.getDefinition();
   FDR FLE = (FDR)ENC.END.cell_technical_parentid.getDefinition();
   FDR FLF = (FDR)ENC.END.cell_technical_settlementid.getDefinition();
   FDR FLG = (FDR)ENC.END.cell_audit_ts_created.getDefinition();
   FDR FLH = (FDR)ENC.END.cell_technical_version.getDefinition();
   FDR FLI = (FDR)ENC.END.cell_business_version.getDefinition();
   FDR FLJ = (FDR)ENC.END.cell_technical_username.getDefinition();
   FDR FLK = (FDR)ENC.END.cell_technical_salt.getDefinition();
   FDR FLL = (FDR)ENC.END.cell_technical_password.getDefinition();
   FDR FLM = (FDR)ENC.END.cell_technical_password_change.getDefinition();
   FDR FLN = (FDR)ENC.END.cell_technical_type.getDefinition();
   FDR FLO = (FDR)ENC.END.cell_technical_subType.getDefinition();
   FDR FLP = (FDR)ENC.END.cell_technical_typeclass.getDefinition();
   FDR FLQ = (FDR)ENC.END.cell_technical_encrypted.getDefinition();
   FDR FLR = (FDR)ENC.END.cell_technical_iv.getDefinition();
   FDR FLS = (FDR)ENC.END.cell_technical_body.getDefinition();
   FDR RHL = (FDR)ENC.END.cell_business_state.getDefinition();
   FDR FLT = (FDR)ENC.END.cell_business_issuer_number.getDefinition();
   FDR FLU = (FDR)ENC.END.cell_business_refid.getDefinition();
   FDR FLV = (FDR)ENC.END.cell_business_periodYear.getDefinition();
   FDR FLW = (FDR)ENC.END.cell_business_periodMonth.getDefinition();
   FDR FLX = (FDR)ENC.END.cell_business_documentIndex.getDefinition();
   FDR FLY = (FDR)ENC.END.cell_business_numeric_value.getDefinition();
   FDR FLZ = (FDR)ENC.END.cell_business_name.getDefinition();
   FDR FMA = (FDR)ENC.END.cell_business_dictionaryName.getDefinition();
   FDR FMB = (FDR)ENC.END.cell_business_dictionaryEntry.getDefinition();
   FDR FMC = (FDR)ENC.END.cell_business_invoicingDate.getDefinition();
   FDR FMD = (FDR)ENC.END.cell_business_creationDate.getDefinition();
   FDR QNR = (FDR)ENC.END.cell_business_transactionDate.getDefinition();
   FDR FME = (FDR)ENC.END.cell_business_contractorName.getDefinition();
   FDR FMF = (FDR)ENC.END.cell_business_contractorNIP.getDefinition();
   FDR FMG = (FDR)ENC.END.cell_business_netValue.getDefinition();
   FDR FMH = (FDR)ENC.END.cell_business_grossValue.getDefinition();
   FDR FMI = (FDR)ENC.END.cell_business_taxValue.getDefinition();
   FDR QNS = (FDR)ENC.END.cell_business_hash.getDefinition();
   FDR FMJ = (FDR)ENC.END.cell_viewQueryId.getDefinition();
   ...
   public interface ENF<_A extends EWD<_B>, _B extends KU> {
      _A HNG(List<END> var1, String var2, Map<String, Map<Integer, List<FDU<?>>>> var3) throws Exception;
   }

   public interface ENE<_A extends EWD<_B>, _B extends KU> {
