...
public class QTV extends QUV<QUD> {
   ...
   private void RLV() throws FFK, FFO {
      ...
      this.RBT = EPB.NEW;
      this.RBS = null;
      ((QUD)this.getProcess()).resetAndCleanUpProcess();
   }
   ...
   private void RLX(HI var1) {
      try {
         new ArrayList();
         QUD var3 = (QUD)this.HHG();
         if (var1.DAI().getValue() != null && ((String)var1.DAI().getValue()).length() != 0 && var1.DAJ().getValue() != null && ((String)var1.DAJ().getValue()).length() != 0) {
