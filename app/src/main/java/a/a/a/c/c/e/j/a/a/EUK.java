    ...
    public void changed(ObservableValue<? extends Period> var1, Period var2, Period var3) {
        if (var3 != null) {
            ...
            if (this.GKW.GLM.getFieldsEditable()) {
                ...
                if (this.GKW.GLM != Mode.EDIT && this.GKW.GLM != Mode.EDIT_CORRECTION && !var4) {
                    this.GKW.fxml_invoice_sale_ref_idController.fxml_component_main_element.IEW().set(false);
                } else if ((this.GKW.GLM == Mode.EDIT || this.GKW.GLM == Mode.EDIT_CORRECTION) && !var4 && this.GKW.GMG != null && this.GKW.GMG.compareTo(this.GKW.fxml_invoice_sale_ref_idController.fxml_component_main_element.getText()) != 0) {
                    this.GKW.fxml_invoice_sale_ref_idController.fxml_component_main_element.IEW().set(false);
                }
