...
public class EYB<_PARENT extends RequiredGridPane, _CONTEXT extends EYF> extends EYH<_PARENT, _CONTEXT> {
    ...
    public void initialize() {
        super.initialize();
        this.GVO.bind(this.fxml_component_main_element.IEU());
        this.GVP.bind(this.fxml_component_main_element.IEW());
        if (this.fxml_component_validation_element != null) {
            ...
            this.fxml_component_validation_element.managedProperty().bind(this.fxml_component_main_element.disableProperty().not().or(this.GVQ).and(this.fxml_component_main_element.IEU().not().and(this.fxml_component_main_element.IFA())));
        }
        ...
        if (this.fxml_component_validation_element_external != null) {
            ...
            this.fxml_component_validation_element_external.managedProperty().bind(this.fxml_component_main_element.disableProperty().not().or(this.GVQ).and(this.fxml_component_main_element.IEU().and(this.fxml_component_main_element.IEW().not().and(this.fxml_component_main_element.IFA()))));
        }
        ...
        if (this.fxml_component_warning_element != null) {
            ...
            this.fxml_component_warning_element.managedProperty().bind(this.fxml_component_main_element.disableProperty().not().or(this.GVQ).and(this.fxml_component_main_element.IEU().and(this.fxml_component_main_element.IEW().and(this.fxml_component_main_element.IEY()))));
        }

    }

    public void clearValidProperty() {
        this.fxml_component_main_element.IEU().set(true);
        this.fxml_component_main_element.IEW().set(true);
        this.fxml_component_main_element.IEY().set(false);
    }
}
