...
public class ERB {
   ...
   public void HRQ(HO var1) {
      this.FZA = false;
      BigDecimal var2 = (BigDecimal)var1.getNetPriceForAll().getValue();
      BigDecimal var3 = (BigDecimal)var1.getTaxValueForAll().getValue();
      BigDecimal var4 = (BigDecimal)var1.getGrossValueForAll().getValue();
      Boolean var5 = null;
      if (var1 instanceof HP) {
         var5 = (Boolean)((HP)var1).getTaxDeduction50P().getValue();
      }

      KL var6 = (KL)var1.DBN().getValue();
      EWC var7 = null;
      switch (var6) {
         case RATE_23:
