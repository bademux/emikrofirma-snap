...
public enum JG implements JM {
   ...
   @XmlTransient
   private ReadOnlyBooleanProperty CMY = new CCS(this);
   @XmlTransient
   private ReadOnlyBooleanProperty CMZ = new CCT(this);
   @XmlTransient
   private ReadOnlyBooleanProperty CNA = new CCU(this);
   @XmlTransient
   private ReadOnlyBooleanProperty CNB = new CCV(this);

   private JG(String var3) {
      EXF.getInstance().ICO();
