...
public class EVH {
   ...
   private void initialize() {
      ...
      try {
         ...
         ((DatePickerRequired)this.fxml_invoicing_date_dateController.fxml_component_main_element).valueProperty().addListener(new ChangeListener<LocalDate>() {
            public void changed(ObservableValue<? extends LocalDate> var1, LocalDate var2, LocalDate var3) {
               EXF.getInstance().ICO();

               try {
                  if (var3 != null) {
                     ((DatePickerRequired)EVH.this.fxml_invoicing_date_dateController.fxml_component_main_element).IEU().set(true);
                     boolean var4 = false;
                     ...
                     if (var4) {
                        ...
                        ((DatePickerRequired)EVH.this.fxml_invoicing_date_dateController.fxml_component_main_element).IEU().set(false);
                        return;
                     }
                     ...
                     try {
                        var5 = EVH.this.implemantation.RKZ(new JN(var3), (String)EVH.this.GPB.DAS().getValue());
                     } catch (FFO | FFK var11) {
