...
public class QTB extends ELX implements EYL {
   ...
   protected void HHI() {
      ...
      try {
         if (this.QZO == null) {
            this.QZO = (HR)this.getModelManager().HJX(this.getParentDefinition(), QSF.class);
   ...
   private void RKE(HI var1) {
      AGYN var2 = new AGYN(HI.class, (String)var1.getNip().getValue());
   ...
   public boolean RKF(JN var1, KE var2, KA var3) {
      ...
      try {
         ...
         if (var1 != null && var1.getYear() != null && var1.getMonth() != null && var2 != null && var2.getValue() != null) {
            IU var5 = new IU(HR.class, (QSW)null, var1, IB.PURCHASE, (IA)null, new KE(var2), var3, (String)null);
            ...
            if (((List)var6.getSecondValue()).isEmpty()) {
               ...
               boolean var7 = false;
               if (this.QZQ != null) {
                  JN var8 = (JN)this.QZQ.getFirstValue();
                  KE var9 = (KE)this.QZQ.getSecondValue();
                  KA var10 = (KA)this.QZQ.getThirdValue();
