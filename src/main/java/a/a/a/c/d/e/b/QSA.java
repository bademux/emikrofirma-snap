...
public class QSA implements QRX<HO> {
   ...
   public HO RIB(HO var1, HO var2) {
      ...
      BigDecimal var6;
      if (var5) {
         var6 = EQY.HRH((BigDecimal)var2.RIF().getValue(), (BigDecimal)var2.DBG().getValue());
         var2.DBM().setValue(var6);
      }

      if (var4) {
         var6 = BigDecimal.ZERO;
         if (!((KL)var2.DBN().getValue()).DEQ() || !this.QWG) {
            var6 = ((KL)var2.DBN().getValue()).getRate().divide(new BigDecimal(100)).setScale(EQY.FYD);
         }

         BigDecimal var7 = EQY.HRH((BigDecimal)var2.DBM().getValue(), var6);
      ...
      if (var3) {
         var6 = EQY.HRJ((BigDecimal)var2.DBM().getValue(), (BigDecimal)var2.DBL().getValue());
         var2.DBK().setValue(var6);
      }

      var2.RIG().setValue(QSV.GROSS);
      var2.DBI().setValue(EQY.QOK((BigDecimal)var2.DBK().getValue(), (BigDecimal)var2.DBG().getValue()));
      return var2;
   }
}
