...
public class EUG {
    ...
    @FXML
    public EZP<TaxRate> fxml_invoice_sale_new_add_invoice_element_tax_typeController;
    @FXML
    ...
    private void initialize() {
        ...
        this.fxml_invoice_sale_new_add_invoice_element_tax_typeController.fxml_component_main_element.getItems().addAll(TaxRate.values());
    ...
    public void setDefault() {
        ((ComboBoxRequired) this.fxml_invoice_sale_new_add_invoice_element_tax_typeController.fxml_component_main_element).getSelectionModel().select(TaxRate.RATE_23);
