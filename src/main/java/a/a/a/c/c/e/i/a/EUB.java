...
public class EUB {
      ...
      try {
         var1 = (File)FEL.IKS(new FEM<File>() {
            public File IKT() {
               ...
               FileChooser.ExtensionFilter var2 = new FileChooser.ExtensionFilter(EUB.this.resources.getString("micro.types.csv.filetype.xml") + " (*.csv, *.txt)", new String[]{"*.csv", "*.txt"});
   ...
   private File HWV(final AGXA var1) {
      ...
      File var2;
      try {
         var2 = (File)FEL.IKS(new FEM<File>() {
            public File IKT() {
               FileChooser var1x = new FileChooser();
               var1x.setTitle(EUB.this.resources.getString("micro.types.xml.fileselect"));
               FileChooser.ExtensionFilter var2 = new FileChooser.ExtensionFilter(EUB.this.resources.getString("micro.types.xml.filetype.xml") + " (*.xml)", new String[]{"*.xml"});
