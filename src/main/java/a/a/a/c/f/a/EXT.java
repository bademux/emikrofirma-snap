...
public class EXT<_PARENT extends RequiredGridPane, _CONTEXT extends EYA> extends EYB<_PARENT, _CONTEXT> {
   ...
   public void initialize() {
      super.initialize();
      ((EYA)this.fxml_component_main_element).IFC().bind(this.fxml_component_root_element.requiredProperty());
      this.GVI.bind(((EYA)this.fxml_component_main_element).IFC());
      this.GVJ.bind(((EYA)this.fxml_component_main_element).IFE());
      ...
      this.fxml_component_required_element.managedProperty().bind(((EYA)this.fxml_component_main_element).changedProperty().and(((EYA)this.fxml_component_main_element).IFC().and(((EYA)this.fxml_component_main_element).IEZ())));
   }
}
