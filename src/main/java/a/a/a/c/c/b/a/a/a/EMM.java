...
public class EMM extends EMI {
   ...
   private BooleanProperty FHV = new SimpleBooleanProperty(this, "usePassword", true);
   private BooleanProperty QNQ = new SimpleBooleanProperty(this, "canRegister", true);
   ...
   protected void fxml_handleButton_login(ActionEvent var1) {
      ...
      try {
         ...
         if (!EMB.getInstance().HHR((String)this.fxml_userName.getValue(), this.fxml_passwordField.getText())) {
            throw FCZ.getInstance().IHA();
         }

         this.RHG = (String)this.fxml_userName.getValue();
   ...
   protected void fxml_handleComboBox_action(ActionEvent var1) {
      ...
      try {
         ...
         String var2 = (String)this.fxml_userName.getValue();
         if (var2 == null) {
            return;
         }

         LX var3 = EMB.getInstance().getSimpleUserDataForUserName(var2);
         this.FHV.set((Boolean)var3.DFB().getValue());
      } catch (FFK var7) {
         ...
         this.fxml_passwordField.setOnKeyPressed(new EventHandler<KeyEvent>() {
            public void handle(KeyEvent var1) {
               if (KeyCode.ENTER.equals(var1.getCode())) {
                  EMM.this.fxml_handleButton_login((ActionEvent)null);
               }
