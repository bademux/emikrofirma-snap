...
public abstract class LJ extends KX<Integer> {
   ...
   public int compareTo(KX<Integer> var1) {
      return var1 != null && var1.getValue() != null ? ((Integer)var1.getValue()).compareTo((Integer)this.getValue()) : -1;
   }
   ...
   public String getValueAsString() {
      Integer var1 = (Integer)this.getValue();
   ...
   private class LK extends SimpleIntegerProperty {
      ...
      public int get() {
         return (Integer)this.APW.getValue();
      }
