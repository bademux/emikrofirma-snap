...
public class EDF<_A extends KV> extends KV {
   ...
   public QSW getState() {
      return (QSW)this.getEnumValue(QSW.class, "business_state");
   }
   ...
   public JN getPeriod() {
      ...
      JN var3;
      try {
         Integer var1 = (Integer)this.getValue("business_periodYear");
         Integer var2 = (Integer)this.getValue("business_periodMonth");
