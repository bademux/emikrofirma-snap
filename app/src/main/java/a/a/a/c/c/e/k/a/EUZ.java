...
public class EUZ extends ENL<EVC> implements EMO<RecordElementVat> {
    ...
    @FXML
    private TableView<RecordElementVat> fxml_cash_register_items;
    @FXML
    private TableView<ReceiptRecord> fxml_cash_register_summary;
    @FXML
    private TableColumn<RecordElementVat, Object> fxml_cash_register_items_net;
    @FXML
    private TableColumn<RecordElementVat, Object> fxml_cash_register_items_vat_amount;
    @FXML
    private TableColumn<RecordElementVat, Object> fxml_cash_register_items_gross;
    @FXML
    public TableColumn<ReceiptRecord, String> fxml_cash_register_summary_summary;
    @FXML
    private TableColumn<ReceiptRecord, Amount> fxml_cash_register_summary_net;
    @FXML
    private TableColumn<ReceiptRecord, Amount> fxml_cash_register_summary_vat_amount;
    @FXML
    private TableColumn<ReceiptRecord, Amount> fxml_cash_register_summary_gross;
    @FXML
    private TableColumn<RecordElementVat, Object> fxml_cash_register_items_vat_rate;
    @FXML
    ...
    private ObservableList<RecordElementVat> GND;
    private boolean GNE;
    ...
    public boolean HHB() {
        ...
        try {
            boolean var1 = true;
            if (!this.GNI && !Mode.VIEW.equals(this.GNA)) {
                if (this.GNG.get()) {
    ...
    public void HHC() {
        ...
        try {
            ...
            this.GNE = true;
            EVC var1 = this.HHG();
            if (Mode.EDIT.equals(this.GNA)) {
                this.GNB.setPreviousPeriod(this.GNB.getPeriod().DDN());
            }

            if (Mode.VIEW.equals(this.GNA)) {
                this.GNF.set(false);
            ...
            this.HYF();
            if (!Mode.EDIT.equals(this.GNA) && !Mode.VIEW.equals(this.GNA)) {
    ...
    protected void fxml_handleCash_register_addRowButton(ActionEvent var1) {
        ...
        try {
            ...
            RecordElementVat var7 = new RecordElementVat();
    ...
    protected void fxml_handleCash_register_RemoveRowButton(ActionEvent var1) {
        ...
        try {
            ...
            RecordElementVat var2 = this.fxml_cash_register_items.getSelectionModel().getSelectedItem();
            if (var2 != null) {
                this.GNJ.HYM(var2);
    ...
    private void HYC() throws FFO, FFK {
        ...
        var1.setCreationDate(new InvoicingDate(this.fxml_include_date_boxController.fxml_component_main_element.getValue()));
    ...
    public void fxml_handleButton_generalButtonSave(ActionEvent var1) {
        ...
        try {
            ...
            this.HYC();
            this.GNJ.HHL();
            this.getApplication().initController(this.getFxmlName(), Stage.CASH_REGISTER_LIST.getProcessFxmlFileName(), null);
        } catch (Exception var6) {
            org.slf4j.LoggerFactory.getLogger(getClass()).error("Something bad happened", var6);
            FCT.IGX("", var6);
        }
    ...
    public void RJV(RecordElementVat var1, RecordElementVat var2, CalculationMethodType var3) {
