...
public class ERN extends ELU<ERU> {
   ...
   private LS GAH;
   private LS GAI;
   private BooleanProperty GAJ = new SimpleBooleanProperty(this, "changedPropertyHolder", false);
   private BooleanProperty RAA = new SimpleBooleanProperty(this, "innerChangedPropertyHolder", false);
   private ERO GAK;
   private ERO GAL;
   private boolean GAN;
   @FXML
