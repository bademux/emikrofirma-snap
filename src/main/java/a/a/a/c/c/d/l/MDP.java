...
public class MDP extends EQK {
   ...
   private MME<Boolean, String, String, String, LocalDate, BigDecimal, String> getKDDataDialog() throws URISyntaxException {
      ...
      MME var1;
      try {
         var1 = (MME)FEL.IKS(new FEM<MME<Boolean, String, String, String, LocalDate, BigDecimal, String>>() {
            public MME<Boolean, String, String, String, LocalDate, BigDecimal, String> IKT() {
               ...
               try {
                  ...
                  try {
                     ...
                     var3.setScene(var4);
                     MDG var5 = (MDG)var1.getController();
                     ...
                     String var7 = null;
                     if (var6) {
                        var7 = ((TextFieldValidated_PESEL)var5.fxml_include_peselController.fxml_component_main_element).getText();
                     } else {
                        var7 = ((TextFieldValidated_NIP)var5.fxml_include_nipController.fxml_component_main_element).getText();
                     }

                     var8 = new MME(var6, var7, ((TextFieldValidated_Text)var5.fxml_include_firstNameController.fxml_component_main_element).getText(), ((TextFieldValidated_Text)var5.fxml_include_lastNameController.fxml_component_main_element).getText(), ((DatePickerRequired)var5.fxml_include_birthDateController.fxml_component_main_element).getValue(), ((TextFieldValidated_Number)var5.fxml_include_taxAmountController.fxml_component_main_element).getNumber(), ((TextFieldValidated_Email_KD)var5.fxml_include_emailController.fxml_component_main_element).getText());
