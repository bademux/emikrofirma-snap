...
public class AGXA {
    public static final AGXA AHSV = new AGXA("http://jpk.mf.gov.pl/wzor/2017/11/13/1113/", "JPK_VAT", "JPK_VAT (3)", "1-1", "3", null);
    public static final AGXA QLP = new AGXA("http://jpk.mf.gov.pl/wzor/2019/09/27/09271/", "JPK_FA", "JPK_FA (3)", "1-0", "3", null);
    private String AHSW;
    private String AHSX;
    private String AHSY;
    private String AHSZ;
