...
public class EXK extends Application implements EVW {
    ...
    private void IDN(String var1, String var2, String var3) {
        ...
        try {
            this.IDP(var1, var2, var3, null, null, null, false);
        } finally {
            EXF.getInstance().ICP();
        }
    ...
    private void IEA(Double var1) {
        this.GTW.set_progress(null, null, var1);
    }
        ...
        try {
            ...
            if (this.GUF != null) {
                ...
                while (var8.hasNext()) {
                    ...
                    var11 = 0.1 + 0.8 * ((double) var7 / (double) var6);
                    ...
                    while (true) {
                        ...
                        if (var25 == null || !var25.equals(var18) || var27 == null || !var27.equals(var17)) {
                            var5 = false;
                            EXF.getInstance().ICA("Checksum not valid for library [" + var19 + "]!");
                            break label798;
                        }
                        ...
                        if (var30 == null) {
                            var5 = false;
                            EXF.getInstance().ICA("Could not accuire lock for file [" + var22 + "]!");
                            break label798;
                        }
                    ...
                    try {
                        ...
                        while (var8.hasNext()) {
                            ...
                            while (var86.hasNext()) {
                                ...
                                double var90 = 0.1 + 0.8 * ((double) (var7 * var84 + var85) / (double) (var6 * var84));
    ...
    private void RHY(EWE<String, String, String, String, String, Integer> var1, EWE<String, String, String, String, String, Integer> var2, EWE<String, String, String, String, String, Integer> var3, File var4, File var5) throws Exception {
        ...
        try {
            ...
            String var18;
            if (var1 != null) {
                String var10 = var1.getSecondValue();
                String var11 = var1.getThirdValue();
                String var12 = var1.getFourthValue();
                var13 = var1.getFifthValue();
                Integer var14 = var1.getSixthValue();
                ...
                if (var18 != null && var18.equals(var12) && var17 != null && var17.equals(var11)) {
                    ...
                    var7 = null;
                    EXF.getInstance().ICA("Checksum not valid for library [" + var13 + "]!");
                }
            }
            ...
            String var44;
            if (var2 != null) {
                var13 = var2.getSecondValue();
                String var41 = var2.getThirdValue();
                var15 = var2.getFourthValue();
                var44 = var2.getFifthValue();
                Integer var45 = var2.getSixthValue();
               ...
               var37 = !var39.exists();
                ...
                if (var22 != null && var22.equals(var15) && var21 != null && var21.equals(var41)) {
                   var37 = !var39.exists();
                    ...
                    var38 = null;
                    EXF.getInstance().ICA("Checksum not valid for library [" + var44 + "]!");
                }
            }
            ...
            File var42 = null;
            if (var3 != null) {
                var15 = var3.getSecondValue();
                var44 = var3.getThirdValue();
                var17 = var3.getFourthValue();
                var18 = var3.getFifthValue();
                Integer var48 = var3.getSixthValue();
                ...
                if (var24 == null || !var24.equals(var17) || var23 == null || !var23.equals(var44)) {
                    ...
                    var40 = null;
                    EXF.getInstance().ICA("Checksum not valid for library [" + var18 + "]!");
                }
            }
    ...
    private void IEI(File var1, String var2, File var3, File var4) throws Exception {
        ...
        try {
            ...
            if (var1 != null && var1.exists()) {
                if (var5 != null) {
                    EWA var7 = this.GUG.get(var5.getAbsolutePath());
                    if (var7 != null) {
