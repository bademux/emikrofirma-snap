...
public class EMP extends EMD {
   ...
   private Map<Integer, EVZ<QVH, ContextMenu>> RHF = new HashMap();
   private List<EVZ<Boolean, Button>> FHY = new ArrayList();
      ...
      try {
         ...
         if (var1 != null) {
            if (var1.getLoginType() != null) {
               this.fxml_left_bar_label.textProperty().setValue(((KG)var1.DFA().getValue()).getDescription());
            }

            if (var1.getUsername() != null) {
               this.fxml_left_bar_text.textProperty().setValue((String)var1.getUsername().getValue());
            }
         }
      } catch (FFK var5) {
         this.QPN();
               ...
               (new EVN() {
                  public void HZI() {
                     ...
                     try {
                        ...
                        StringBuilder var2 = new StringBuilder(EMP.this.resources.getString("micro.leftbar.contact.mail.subject"));
                        var2.append(" [");
                        var2.append((new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssz")).format(new Date()));
                        var2.append(" ]");
                        var1.append("&subject=").append(URLEncoder.encode(var2.toString(), StandardCharsets.UTF_8.name()).replace("+", "%20"));
      ...
      try {
         ...
         TreeSet var4 = new TreeSet(new Comparator<EWD<Integer>>() {
            public int compare(EWD<Integer> var1, EWD<Integer> var2) {
               return ((Integer)var1.getFirstValue()).compareTo((Integer)var2.getFirstValue());
            }
         });
         ...
         while(var6.hasNext()) {
            ...
            this.HJM(this.FHX, var37, var11, var35, var41, (ENB)null);
         }
         ...
         while(var6.hasNext()) {
            ...
            switch (var36) {
               ...
               case CONTEXT:
                  ...
                  final Button var45 = this.HJP(this.fxml_left_bar.getChildren(), var41, var11, (EventHandler)null, var44);
