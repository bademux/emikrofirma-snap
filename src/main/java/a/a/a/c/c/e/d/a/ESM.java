...
public class ESM {
   ...
   private void initialize() {
      ...
      try {
         ((ComboBoxRequired)this.fxml_include_taxRateRequiredComboBox_boxController.fxml_component_main_element).setCellFactory(new EOQ());
         ((ComboBoxRequired)this.fxml_include_taxRateRequiredComboBox_boxController.fxml_component_main_element).setButtonCell((ListCell)((ComboBoxRequired)this.fxml_include_taxRateRequiredComboBox_boxController.fxml_component_main_element).getCellFactory().call(null));
         ...
         ((ComboBoxRequired)this.fxml_include_taxReasonRequiredComboBox_boxController.fxml_component_main_element).setCellFactory(new EOQ());
         ((ComboBoxRequired)this.fxml_include_taxReasonRequiredComboBox_boxController.fxml_component_main_element).setButtonCell((ListCell)((ComboBoxRequired)this.fxml_include_taxReasonRequiredComboBox_boxController.fxml_component_main_element).getCellFactory().call(null));
   ...
   public void setupDefaults(ResourceBundle var1) {
      ...
      try {
         ...
         ((TextFieldValidated_Text)this.fxml_include_measurementUnitRequiredTextBox_boxController.fxml_component_main_element).setText(var1.getString("micro.process.invoice_purchase_addNewPosition.Quantity.DefaultUnit"));
   ...
   public void setProductAutocomplete(ESX var1) {
      ...
      ((ComboBoxRequired)this.fxml_include_itemNameRequiredTextBox_boxController.fxml_component_main_element).setOnKeyReleased(new QKK(this.GDQ));
   }
}
