...
@Slf4j
public class HttpSenderResult<_RESULT_TYPE> implements Serializable {
    ...
    public HttpSenderResult(_RESULT_TYPE var1, Throwable var2, Map<String, List<String>> var3) {
