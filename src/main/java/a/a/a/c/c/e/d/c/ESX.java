...
public class ESX extends ELX implements EYL {
   ...
   protected void HHI() {
      ...
      try {
         if (this.GFE == null) {
            this.GFE = (HR)this.getModelManager().HJX(this.getParentDefinition(), HR.class);
      ...
      try {
         ...
         if (var1 != null && var1.getYear() != null && var1.getMonth() != null && var2 != null && var2.getValue() != null) {
            ...
            if (((List)var6.getSecondValue()).isEmpty()) {
               ...
               boolean var7 = false;
               if (this.GFG != null) {
                  JN var8 = (JN)this.GFG.getFirstValue();
                  KE var9 = (KE)this.GFG.getSecondValue();
                  KA var10 = (KA)this.GFG.getThirdValue();
