...
public class EYX extends EXU {
   ...
   private BooleanProperty GVZ = new SimpleBooleanProperty(this, "valid", true);
   private BooleanProperty GWA = new SimpleBooleanProperty(this, "disable", false);
   private ObjectProperty<JN> GWB = new SimpleObjectProperty();
   ...
   public Integer getYear() {
      return (Integer)this.fxml_period_year.getValue();
   }

   public Integer getMonth() {
      return (Integer)this.fxml_period_month.getValue();
   }

   public JN getPeriod() {
      return this.fxml_period_year.getValue() != null && this.fxml_period_month.getValue() != null ? new JN((Integer)this.fxml_period_year.getValue(), (Integer)this.fxml_period_month.getValue()) : null;
   }

   public void setPeriod(JN var1) {
      if (var1 != null) {
         this.setPeriod((Integer)var1.getYear().getValue(), (Integer)var1.getMonth().getValue());
      } else {
