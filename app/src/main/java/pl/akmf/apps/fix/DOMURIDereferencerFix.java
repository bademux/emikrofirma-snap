    ...
    public Data dereference(URIReference var1, XMLCryptoContext var2) throws URIReferenceException {
        if (var1 == null) {
            ...
            if (var9 && Policy.restrictReferenceUriScheme(var5)) {
                ...
                if (var5 != null && var5.length() != 0 && var5.charAt(0) == '#') {
                    ...
                    if (var20 != null) {
                        if (var9 && Policy.restrictDuplicateIds()) {
                            ...
                            if (!XMLUtils.protectAgainstWrappingAttack(var13, var20, var10)) {
                ...
                try {
                    XMLSignatureInput var19 = ResourceResolver.resolve(new ResourceResolverContext(var4, var7, true));
                    return var19.isOctetStream() ? new ApacheOctetStreamData(var19) : new ApacheNodeSetData(var19);
