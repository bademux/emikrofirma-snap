         ...
         while(true) {
            label219: {
               if ((var7 = var4.readLine()) != null) {
                  ...
                  if (var2 == 1) {
                     EXF.getInstance().ICK("KodFormularza " + (String)var6.get(0) + " " + "KodFormularza".equals(var6.get(0)));
                     EXF.getInstance().ICK(var6.get(0));
                     EXF.getInstance().ICK(((String)var6.get(0)).length());
                     EXF.getInstance().ICK("KodFormularza".length());
                     EXF.getInstance().ICK("kodSystemowy " + (String)var6.get(1) + " " + "kodSystemowy".equals(var6.get(1)));
                     EXF.getInstance().ICK("wersjaSchemy " + (String)var6.get(2) + " " + "wersjaSchemy".equals(var6.get(2)));
                     EXF.getInstance().ICK("WariantFormularza " + (String)var6.get(3) + " " + "WariantFormularza".equals(var6.get(3)));
                     if (!"KodFormularza".equals(var6.get(0)) || !"kodSystemowy".equals(var6.get(1)) || !"wersjaSchemy".equals(var6.get(2)) || !"WariantFormularza".equals(var6.get(3))) {
                        throw FCZ.getInstance().IHV("KodFormularza, kodSystemowy, wersjaSchemy, WariantFormularza", (String)var6.get(0) + ", " + (String)var6.get(1) + ", " + (String)var6.get(2) + ", " + (String)var6.get(3));
                     }
               ...
               if (var6 != null && var6.size() > 4) {
                  throw FCZ.getInstance().IHZ((String)var6.get(0) + " " + (String)var6.get(1) + " " + (String)var6.get(2) + " " + (String)var6.get(3));
               }
