...
public class EZP<_T> extends EXZ<_T, RequiredGridPane, ComboBoxRequired<_T>> {
   ...
   public void initialize() {
      super.initialize();
      ((ComboBoxRequired)this.fxml_component_main_element).promptTextProperty().unbindBidirectional(this.fxml_component_root_element.labelProperty());
      ((ComboBoxRequired)this.fxml_component_main_element).promptTextProperty().set("");
