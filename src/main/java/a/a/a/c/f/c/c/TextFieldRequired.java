...
public class TextFieldRequired extends TextFieldValidated implements EXV {
   ...
   private void IFW() {
      ...
      this.setOnKeyPressed(new EventHandler<KeyEvent>() {
         ...
         {
            this.AAVL = new KeyCodeCombination(KeyCode.Z, new KeyCombination.Modifier[]{KeyCombination.SHORTCUT_DOWN});
            this.AAVM = new KeyCodeCombination(KeyCode.Y, new KeyCombination.Modifier[]{KeyCombination.SHORTCUT_DOWN});
         }
