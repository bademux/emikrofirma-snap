...
@XmlTransient
@XmlSeeAlso({VariableDate.class, VariableBigDecimal.class, VariableInteger.class})
public abstract class VariableRef<_T> extends ConfigurationBaseAbstract {
    ...
    public VariableRef(String var1, _T var2) {
        super(var1);
