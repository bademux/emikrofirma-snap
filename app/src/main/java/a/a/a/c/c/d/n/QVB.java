...
public class QVB<_T extends QSG<?>> {
    ...
    public _T getRealInvoice() throws FFK {
        if (this.RFK == null) {
            this.RFK = this.RFJ.getModelBaseElementWithIdObject();
        }
    ...
    public Date getInvoicingDate() {
        if (this.RFP == null) {
            this.RFP = this.RFJ.getValue("business_invoicingDate");
        }
    ...
    public String getRefId() {
        if (this.RFQ == null) {
            this.RFQ = this.RFJ.getValue("business_refid");
        }
    ...
    public String getContractorName() {
        if (this.RFR == null) {
            this.RFR = this.RFJ.getValue("business_contractorName");
        }
    ...
    public String getContractorNip() {
        if (this.RFS == null) {
            this.RFS = this.RFJ.getValue("business_contractorNIP");
        }
    ...
    public BigDecimal getSumNet() {
        if (this.RFM == null) {
            this.RFM = this.RFJ.getValue("business_netValue");
        }
    ...
    public BigDecimal getSumTax() {
        if (this.RFN == null) {
            this.RFN = this.RFJ.getValue("business_taxValue");
        }
    ...
    public BigDecimal getSumBrut() {
        if (this.RFO == null) {
            this.RFO = this.RFJ.getValue("business_grossValue");
        }
