   ...
   protected void HHI() {
      ...
      try {
         if (this.GBS == null) {
            ...
            if (this.GBS == null) {
               String var2 = (String)EMB.getInstance().getCurrentUser().getUsername().getValue();
               if (var2 == null) {
                  throw new FFK("Not supposed to happen, userName is null!");
               }

               LX var3 = EMB.getInstance().getSimpleUserDataForUserName(var2);
               switch ((KG)var3.DFA().getValue()) {
                  case NIP:
                     this.GBS = new LY();
                     this.GBS.DEW().setValue(1);
                     this.GBS.setNip(new KA((String)var3.getUsername().getValue()));
                     break;
                  default:
