...
public class EYZ extends EXZ<String, RequiredGridPane, ComboBoxRequired<String>> {
   ...
   public void initialize() {
      ...
      ((ComboBoxRequired)this.fxml_component_main_element).editableProperty().set(true);
      final Tooltip var1 = new Tooltip();
      var1.textProperty().bind(((ComboBoxRequired)this.fxml_component_main_element).getEditor().textProperty());
      var1.setWrapText(true);
      var1.setMaxWidth(200.0);
      ((ComboBoxRequired)this.fxml_component_main_element).getEditor().textProperty().addListener(new ChangeListener<String>() {
      ...
      ((ComboBoxRequired)this.fxml_component_main_element).setOnMouseEntered(new EventHandler<MouseEvent>() {
         public void handle(MouseEvent var1x) {
            if (((ComboBoxRequired)EYZ.this.fxml_component_main_element).getEditor().getText().length() > 30) {
               var1.show(EYZ.this.QVM);
            }

         }
      });
      ((ComboBoxRequired)this.fxml_component_main_element).setOnMouseExited(new EventHandler<MouseEvent>() {
         public void handle(MouseEvent var1x) {
            var1.hide();
         }
      });
      ((ComboBoxRequired)this.fxml_component_main_element).getEditor().setTextFormatter(new TextFormatter(new UnaryOperator_Text(((ComboBoxRequired)this.fxml_component_main_element).getEditor(), this.GWD)));
      ((ComboBoxRequired)this.fxml_component_main_element).getEditor().focusedProperty().addListener(new ChangeListener<Boolean>() {
         public void changed(ObservableValue<? extends Boolean> var1x, Boolean var2, Boolean var3) {
            if (!var3) {
               String var4 = ((ComboBoxRequired)EYZ.this.fxml_component_main_element).getEditor().getText();
               if (var4 != null) {
                  String var5 = var4.trim();
                  if (var5.length() > 0) {
                     ((ComboBoxRequired)EYZ.this.fxml_component_main_element).getEditor().setText(var5);
                  } else {
                     ((ComboBoxRequired)EYZ.this.fxml_component_main_element).getEditor().setText((String)null);
                  }
               }
      ...
      ((ComboBoxRequired)this.fxml_component_main_element).setCellFactory(new Callback<ListView<String>, ListCell<String>>() {
         public ListCell<String> call(ListView<String> var1) {
            return new ListCell<String>() {
               private HBox generateView() {
                  Text var1 = new Text();
                  var1.setText((String)this.getItem());
                  ...
                  HBox var4 = new HBox(new Node[]{var1});
                  var4.setAlignment(Pos.CENTER_LEFT);
                  HBox var5 = new HBox(new Node[]{var4, var2});
      ...
      ((ComboBoxRequired)this.fxml_component_main_element).valueProperty().addListener(new ChangeListener<String>() {
         public void changed(ObservableValue<? extends String> var1, String var2, String var3) {
            ((ComboBoxRequired)EYZ.this.fxml_component_main_element).hide();
      ...
      ((ComboBoxRequired)this.fxml_component_main_element).setSkin(new ComboBoxListViewSkin<String>((ComboBox)this.fxml_component_main_element) {
