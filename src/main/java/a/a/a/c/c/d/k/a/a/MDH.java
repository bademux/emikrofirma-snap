...
public class MDH implements ChangeListener<Boolean> {
   ...
   public void changed(ObservableValue<? extends Boolean> var1, Boolean var2, Boolean var3) {
      if (var3 != null && !var3 && this.MWG.isValid()) {
         LocalDate var4 = MWY(((TextFieldValidated_PESEL)this.MWG.fxml_component_main_element).getText());
         if (var4 != null) {
            ((DatePickerRequired)this.MWH.fxml_component_main_element).setValue(var4);
         }
      }
