...
public class EXL extends URLClassLoader {
   ...
   private final URL GUP = new URL((URL)null, "bytes:/DYNAMIC_RESOURCES!/", new URLStreamHandler() {
   ...
   private synchronized byte[] IEL(String var1, String var2) {
      try {
         if (!this.GUM.containsKey(var1)) {
            ...
            try {
               byte[] var4 = (byte[])this.GUK.get(var2);
         ...
         byte[] var13 = (byte[])this.GUM.get(var1);
         return var13;
   ...
   private synchronized Class<?> IEM(String var1, String var2, String var3, Manifest var4) {
         ...
         if (var7 != -1) {
            ...
            if (!this.GUO.containsKey(var8)) {
               ...
               if (var4 != null) {
                  ...
                  var10 = this.definePackage(var8, (String)null, (String)null, (String)null, (String)null, (String)null, (String)null, var9);
               }
      ...
      Class var12 = (Class)this.GUN.get(var1);
      return var12;
   }
   ...
   public InputStream getResourceAsStream(String var1) {
      if (this.GUL.containsKey(var1)) {
         String var2 = ((EXM)this.GUL.get(var1)).getJarName();
   ...
   protected Class<?> findClass(String var1) throws ClassNotFoundException {
      ...
      if (this.GUL.containsKey(var2)) {
         EXM var3 = (EXM)this.GUL.get(var2);
   ...
   protected Package getPackage(String var1) {
      return this.GUO.containsKey(var1) ? (Package)this.GUO.get(var1) : super.getPackage(var1);
   }
