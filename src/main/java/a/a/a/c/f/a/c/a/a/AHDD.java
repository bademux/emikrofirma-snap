...
public abstract class AHDD<_T> extends AHDB {
   ...
   public AHDD(AHCJ var1, String var2, AHDG var3, Class<? extends AHCB<_T>> var4, AHDH[] var5, String[] var6) {
      ...
      try {
         ...
         this.AHVG = (AHDH[])EWY.IBM(AHDH.class, var5);
         this.AHVH = (String[])EWY.IBM(String.class, var6);
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public AHCB<_T> getCustomAction() {
      try {
         ...
         Constructor[] var2 = (Constructor[])this.AHVF.getConstructors();
      ...
      } catch (InstantiationException | IllegalAccessException | SecurityException | IllegalArgumentException | InvocationTargetException | NullPointerException var9) {
