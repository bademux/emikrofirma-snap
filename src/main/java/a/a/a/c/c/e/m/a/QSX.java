   ...
   protected void fxml_handleButton_registry_addNewAggreagatePosition(ActionEvent var1) {
      ...
      try {
         if (this.REZ != null) {
            ...
            var4.setScene(var5);
            QSY var6 = (QSY)var2.getController();
            var6.setDialogStage(var4);
            var6.setupDefaults(this.resources);
            var4.showAndWait();
            if (var6.getResult()) {
               HP var7 = new HP();
               var7.setNetPriceForAll(new JR(((TextFieldValidated_Number)var6.fxml_include_netValueNumberBox_boxController.fxml_component_main_element).getNumber()));
               var7.setTaxValueForAll(new JR(((TextFieldValidated_Number)var6.fxml_include_taxValueNumberBox_boxController.fxml_component_main_element).getNumber()));
               var7.setGrossValueForAll(new JR(((TextFieldValidated_Number)var6.fxml_include_netValueNumberBox_boxController.fxml_component_main_element).getNumber().add(((TextFieldValidated_Number)var6.fxml_include_taxValueNumberBox_boxController.fxml_component_main_element).getNumber())));
