...
public abstract class LA extends KX<Boolean> {
   ...
   public int compareTo(KX<Boolean> var1) {
      return var1 != null && var1.getValue() != null ? ((Boolean)var1.getValue()).compareTo((Boolean)this.getValue()) : -1;
   }
   ...
   public String getValueAsString() {
      Boolean var1 = (Boolean)this.getValue();
