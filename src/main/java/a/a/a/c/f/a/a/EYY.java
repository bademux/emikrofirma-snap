...
public class EYY extends EXX {
   ...
   protected void fxml_handleButton_open_button(ActionEvent var1) {
      ...
      try {
         ...
         FileChooser.ExtensionFilter var3 = new FileChooser.ExtensionFilter(this.resources.getString("micro.types.img.filetype.image") + " (*.jpg, *.png)", new String[]{"*.jpg", "*.png"});
         FileChooser.ExtensionFilter var4 = new FileChooser.ExtensionFilter(this.resources.getString("micro.types.img.filetype.all"), new String[]{"*.*"});
         ...
         if (var5 != null) {
            ...
            try {
               ...
               if (var7) {
                  ...
                  BufferedImage var19 = SwingFXUtils.fromFXImage(var18, (BufferedImage)null);
   ...
   protected void fxml_handleButton_clear_button(ActionEvent var1) {
      ...
      try {
         this.fxml_component_main_element.setImage((Image)null);
      } finally {
         EXF.getInstance().ICP();
      }
