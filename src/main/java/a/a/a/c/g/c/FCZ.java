...
public class FCZ {
   ...
   public SAXParseException IIB(int var1) {
      ...
      try {
         var2 = new SAXParseException(this.HBL.getString("micro.parse.exception.expectedelementnotfound").replaceFirst("##NUMOFNODES##", Matcher.quoteReplacement(String.valueOf(var1))), (Locator)null);
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public SAXParseException IIC(String var1) {
      ...
      SAXParseException var2;
      try {
         var2 = new SAXParseException(this.HBL.getString("micro.parse.exception.unexpectedelement").replaceFirst("##ELEMENTNAME##", Matcher.quoteReplacement(var1)), (Locator)null);
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public SAXParseException IID() {
      ...
      try {
         var1 = new SAXParseException(this.HBL.getString("micro.parse.exception.missingtns"), (Locator)null);
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public SAXParseException IIE(String var1) {
      ...
      SAXParseException var2;
      try {
         var2 = new SAXParseException(this.HBL.getString("micro.parse.exception.other").replaceFirst("##EXCEPTION##", Matcher.quoteReplacement(var1)), (Locator)null);
      } finally {
         EXF.getInstance().ICP();
      }
