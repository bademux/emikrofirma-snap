...
public enum MonthType implements EnumTypeValue {
    ...
    MonthType(String var3, int var4) {
        this.AOO = var3;
        this.AOP = var4;
    }
    ...
    public static MonthType getMonthByNumber(int var0) {
        MonthType[] var1 = values();
        int var2 = var1.length;

        for (int var3 = 0; var3 < var2; ++var3) {
            MonthType var4 = var1[var3];
    ...
    public static MonthType getMonthByIntValue(int var0) {
        switch (var0) {
            case 1:
                return M1;
            case 2:
    ...
    public int DAQ(EnumTypeValue var1) {
        return this.compareTo((MonthType) var1);
    }
