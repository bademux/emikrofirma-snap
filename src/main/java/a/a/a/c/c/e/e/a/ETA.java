...
public class ETA extends ELU<ETE> {
   ...
   protected void fxml_handleButton_generalButtonEdit(ActionEvent var1) {
      ...
      try {
         ...
         ETB var6 = (ETB)var2.getController();
         var6.setDialogStage(var4);
         HI var7 = (HI)this.fxml_include_ContactsListLogicController.fxml_contractorsTable.getSelectionModel().getSelectedItem();
         ...
         if (var6.HUO()) {
            ...
            var7.DAI().setValue(((TextFieldValidated_Text)var6.fxml_include_ContractorName_boxController.fxml_component_main_element).getText());
            var7.DAJ().setValue(((TextFieldValidated_NIP)var6.fxml_include_nip_boxController.fxml_component_main_element).getText());
            var7.DAK().setValue(((TextFieldValidated_REGON)var6.fxml_include_regon_boxController.fxml_component_main_element).getText());
            var7.DAL().setValue(((TextFieldValidated_AccountNumber)var6.fxml_include_AccountNumber_boxController.fxml_component_main_element).getText());
            var7.DAM().DDA().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_Street_boxController.fxml_component_main_element).getText());
            var7.DAM().DDB().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_HouseNumber_boxController.fxml_component_main_element).getText());
            var7.DAM().DDC().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_ApartmentNumber_boxController.fxml_component_main_element).getText());
            var7.DAM().DDD().setValue(((TextFieldValidated_PostalCode)var6.fxml_include_address_boxController.fxml_include_PostalCode_boxController.fxml_component_main_element).getText());
            var7.DAM().DCZ().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_City_boxController.fxml_component_main_element).getText());
            var7.DAM().DDE().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_PostOffice_boxController.fxml_component_main_element).getText());
            var7.DAM().DCX().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_District_boxController.fxml_component_main_element).getText());
            var7.DAM().DCY().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_Community_boxController.fxml_component_main_element).getText());
            var7.DAM().DCV().setValue(((TextFieldValidated_Text)var6.fxml_include_address_boxController.fxml_include_CountryCode_boxController.fxml_component_main_element).getText());
            ...
            var7.DAN().setValue(((TextFieldValidated_Phone)var6.fxml_include_address_boxController.fxml_include_telephone_boxController.fxml_component_main_element).getText());
            var7.DAO().setValue(((TextFieldValidated_Email)var6.fxml_include_address_boxController.fxml_include_email_boxController.fxml_component_main_element).getText());
            var7.DAP().setValue(((TextAreaRequired)var6.fxml_include_remarks_boxController.fxml_component_main_element).getText());
            this.GFM = (ETE)this.HHG();
            ...
            ((TableView.TableViewSelectionModel)this.fxml_include_ContactsListLogicController.fxml_contractorsTable.selectionModelProperty().getValue()).select(var7);
         }
   ...
   protected void fxml_handleButton_generalButtonRemove(ActionEvent var1) throws Exception {
      ...
      try {
         ...
         boolean var3 = true;
         if (var2 >= 0) {
            FEN var4 = FCR.getConfirmDataDialog(this.resources.getString("micro.dialog.remove.confirm.title"), (String)null, this.resources.getString("micro.dialog.remove.confirm.button.remove"), this.resources.getString("micro.dialog.remove.confirm.button.cancel"), 500.0, 100.0, this.resources.getString("micro.dialog.remove.confirm.message"));
            switch (var4) {
               case Confirm:
                  var3 = true;
                  this.GFM = (ETE)this.HHG();
                  this.GFM.setContractor((HI)this.fxml_include_ContactsListLogicController.fxml_contractorsTable.getSelectionModel().getSelectedItem());
                  this.GFM.HUQ();
                  this.fxml_include_ContactsListLogicController.GFJ.remove(var2);
                  this.fxml_include_ContactsListLogicController.HUG((HI)this.fxml_include_ContactsListLogicController.fxml_contractorsTable.getSelectionModel().getSelectedItem());
