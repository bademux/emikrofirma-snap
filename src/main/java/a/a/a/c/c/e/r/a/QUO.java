...
public class QUO {
      ...
      try {
         switch (this.REN) {
            ...
            case SELL_REASON_2:
               ...
               ((TextFieldValidated_Number)this.fxml_other_sale_new_add_other_element_netController.fxml_component_main_element).setDisable(false);
               ...
               ((ComboBoxRequired)this.fxml_other_sale_new_add_other_element_tax_typeController.fxml_component_main_element).setDisable(false);
            ...
            case SELL_REASON_4:
               ...
               ((TextFieldValidated_Number)this.fxml_other_sale_new_add_other_element_netController.fxml_component_main_element).setDisable(true);
               ((TextFieldValidated_Number)this.fxml_other_sale_new_add_other_element_taxController.fxml_component_main_element).setDisable(false);
   ...
   private void initialize() {
      ...
      ((ComboBoxRequired)this.fxml_other_sale_new_add_other_element_tax_typeController.fxml_component_main_element).setCellFactory(new EOQ());
      ((ComboBoxRequired)this.fxml_other_sale_new_add_other_element_tax_typeController.fxml_component_main_element).setButtonCell((ListCell)((ComboBoxRequired)this.fxml_other_sale_new_add_other_element_tax_typeController.fxml_component_main_element).getCellFactory().call(null));
