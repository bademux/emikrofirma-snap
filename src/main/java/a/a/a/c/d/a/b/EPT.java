...
public class EPT implements AHCB<Map<AHDS, AHDT>> {
   ...
   public boolean AIBY(Map<AHDS, AHDT> var1) {
      ...
      try {
         this.FUI = null;
         AHDT var2 = (AHDT)var1.get(this.FUG);
         AHDT var3 = (AHDT)var1.get(this.FUH);
         EXF.getInstance().ICK("netValueField " + var2);
         EXF.getInstance().ICK("taxValueField " + var3);
         if (this.FUF != null && ((BigDecimal)this.FUF.getValue()).compareTo(BigDecimal.ZERO) > 0 && var2 != null && var2.AIDH() && var3 != null && var3.AIDH()) {
            BigDecimal var9 = (new BigDecimal(var2.getValue())).multiply((BigDecimal)this.FUF.getValue()).divide(BigDecimal.valueOf(100.0)).setScale(2, 4);
            this.FUI = var9;
