...
public class EXF implements EXG {
    ...
    private Logger GTC;
    private Logger GTD;
    private final Map<Long, Deque<EXH>> GTE = new HashMap();
    ...
    private EXH getCurrentLogger(Thread var1) {
        ...
        EXH var4 = null;
        if (this.GTE.containsKey(var2) && this.GTE.get(var2).size() > 0) {
    ...
    private File getLoggerFile(String var1) {
        LoggerConfig var2 = this.GTF.getLoggers().get(var1);
        Appender var3 = var2.getAppenders().values().iterator().next();
    ...
    public void IBZ(Object var1, Throwable var2) {
        this.getCurrentLogger().ICU(this.getCallerClassName() + var1, var2);
    }

    public void ICA(Object var1) {
        this.getCurrentLogger().ICV(this.getCallerClassName() + var1);
    }
    ...
    public void ICA(Throwable var1) {
        if (var1 != null) {
            ...
            this.getCurrentLogger().ICV(this.getCallerClassName() + "null");
        }

    }

    public void ICB(Object var1, Throwable var2) {
        this.getCurrentLogger().ICW(this.getCallerClassName() + var1, var2);
    }

    public void ICC(Object var1) {
        this.getCurrentLogger().ICX(this.getCallerClassName() + var1);
    }
    ...
    public void ICC(Throwable var1) {
        if (var1 != null) {
            ...
            this.getCurrentLogger().ICX(this.getCallerClassName() + "null");
        }

    }

    public void ICD(Object var1, Throwable var2) {
        this.getCurrentLogger().ICY(this.getCallerClassName() + var1, var2);
    }

    public void ICE(Object var1) {
        this.getCurrentLogger().ICZ(this.getCallerClassName() + var1);
    }

    public void ICF(Object var1, Throwable var2) {
        this.getCurrentLogger().IDA(this.getCallerClassName() + var1, var2);
    }

    public void ICG(Object var1) {
        this.getCurrentLogger().IDB(this.getCallerClassName() + var1);
    }

    public void ICH(Object var1, Throwable var2) {
        this.getCurrentLogger().IDC(this.getCallerClassName() + var1, var2);
    }

    public void ICI(Object var1) {
        this.getCurrentLogger().IDD(this.getCallerClassName() + var1);
    }

    public void ICJ(Object var1, Throwable var2) {
        this.getCurrentLogger().IDE(this.getCallerClassName() + var1, var2);
    }

    public void ICK(Object var1) {
        this.getCurrentLogger().IDF(this.getCallerClassName() + var1);
    }
