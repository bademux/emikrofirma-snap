...
public class JJ extends IJ {
   ...
   public String AICQ() {
      ...
      var1.append((String)Optional.ofNullable(this.ANW.getValue()).orElse(""));
      var1.append(" ");
      var1.append((String)Optional.ofNullable(this.ANX.getValue()).orElse(""));
      String var2 = (String)Optional.ofNullable(this.ANY.getValue()).orElse("");
      if (var2.trim().length() > 0) {
         var1.append(" ");
         var1.append(FCW.getInstance().getMessageForKey("micro.process.invoices_records.apartmentAbbr"));
         var1.append(" ");
         var1.append((String)this.ANY.getValue());
      }

      var1.append(" ");
      var1.append((String)Optional.ofNullable(this.ANZ.getValue()).orElse(""));
      var1.append(" ");
      var1.append((String)Optional.ofNullable(this.ANV.getValue()).orElse(""));
