...
public class ETT extends ELU<ETV> {
   ...
   private BooleanProperty GJA = new SimpleBooleanProperty(false);
   ObservableList<IR> GJB;
   private int GJC = 0;
   private SortedMap<String, SortedSet<KH>> GJD;
   private JN GJF;
   private ChangeListener<String> GJG = new ChangeListener<String>() {
   ...
   private ChangeListener<Integer> GJH = new ChangeListener<Integer>() {
      ...
      try {
         ...
         this.fxml_cash_register_list.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<IR>() {
            public void changed(ObservableValue<? extends IR> var1, IR var2, IR var3) {
               try {
                  if (var3 != null) {
                     boolean var4 = ((ETV)ETT.this.getProcess()).HWH(var3.getCreationDate().getValueDate());
            ...
            public TableCell<IR, KE> call(TableColumn<IR, KE> var1) {
               return new TableCell<IR, KE>() {
                  protected void updateItem(KE var1, boolean var2) {
                     ...
                     if (!var2 && var1 != null) {
                        this.setText((String)var1.getValue());
                     } else {
   ...
   private void HWD(int var1) {
      ...
      try {
         ...
         EVZ var3 = ((ETV)this.getProcess()).getReceiptRecords(12, var2, this.GJF);
         if (var3 != null) {
         ...
         if (var3 != null && var3.getFirstValue() != null) {
            this.GIZ.set((int)Math.ceil((double)((float)(Integer)var3.getFirstValue() / 12.0F)));
         } else {
            this.GIZ.set(0);
         }
   ...
   private Node HWE(int var1) {
      this.HWD(var1);
      return new VBox(new Node[]{this.fxml_cash_register_list});
   }
   ...
   protected void fxml_handleButton_cash_register_list_view(ActionEvent var1) {
      ...
      try {
         ...
         final IR var2 = (IR)this.fxml_cash_register_list.getSelectionModel().getSelectedItem();
         this.HHB();
   ...
   private void HWF() {
      ...
      try {
         ...
         if (this.GJD != null) {
            ...
            this.setPossibleMonths((String)null);
         }
   ...
   private void HWG() {
      String var1 = (String)this.fxml_invoice_sale_list_year.getValue();
      Integer var2 = null;
      ...
      if (this.fxml_invoice_sale_list_month.getValue() != null) {
         var3 = (Integer)this.fxml_invoice_sale_list_month.getValue();
