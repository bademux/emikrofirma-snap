...
public class EMV implements EMU {
   ...
   public <_A extends HN<_B>, _B extends HO> _A HJX(ELZ var1, Class<_A> var2) throws FFK, FFO {
      ...
      try {
         ...
         switch (var3) {
            case InvoiceSell:
               var4 = (HN)var2.newInstance();
               var5 = EMB.getInstance().HHV();
               var4.DAR().setValue((String)var5.DFF().getValue());
      ...
      try {
         ...
         switch (var3) {
            case InvoiceOtherSell:
               var4 = (QSG)var2.newInstance();
               var5 = EMB.getInstance().HHV();
               var4.RIQ().setValue((String)var5.DFF().getValue());
   ...
   public <_T extends IL> void HKB(ELZ var1, _T var2) throws FFK, FFO {
      ...
      try {
         ...
         switch (var3) {
            ...
            case DeclarationJPK_WB:
            case DeclarationJPK_STATUSTRACKER:
               EMB.getInstance().HIK(FDO.update, (HJ)var2, (JF)null);
               break;
            case Contractor:
   ...
   public <_T extends IL> void HKC(ELZ var1, _T var2) throws FFK, FFO {
      ...
      try {
         ...
         switch (var3) {
            ...
            case DeclarationJPK_WB:
            case DeclarationJPK_STATUSTRACKER:
               EMB.getInstance().HIK(FDO.delete, (HJ)var2, (JF)null);
               break;
            case Contractor:
