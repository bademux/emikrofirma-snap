...
public abstract class IC extends EXM {
   ...
   public EVZ<JR, JR> getVat4and8() {
      ...
      if (this.QLT != null && this.QLT.getFirstValue() != null && ((JR)this.QLT.getFirstValue()).getValue() != null) {
         var1 = var1.add((BigDecimal)((JR)this.QLT.getFirstValue()).getValue());
      }

      if (this.ALG != null && this.ALG.getFirstValue() != null && ((JR)this.ALG.getFirstValue()).getValue() != null) {
         var1 = var1.add((BigDecimal)((JR)this.ALG.getFirstValue()).getValue());
      }

      if (this.QLT != null && this.QLT.getSecondValue() != null && ((JR)this.QLT.getSecondValue()).getValue() != null) {
         var2 = var2.add((BigDecimal)((JR)this.QLT.getSecondValue()).getValue());
      }

      if (this.ALG != null && this.ALG.getSecondValue() != null && ((JR)this.ALG.getSecondValue()).getValue() != null) {
         var2 = var2.add((BigDecimal)((JR)this.ALG.getSecondValue()).getValue());
      }
