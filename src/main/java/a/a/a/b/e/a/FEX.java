...
public class FEX extends FES {
   ...
   public static synchronized byte[] IKZ(FFC var0, X509Certificate var1, byte[] var2, byte[] var3, String var4, String var5, String var6, String var7) throws FEV {
      ...
      try {
         ...
         XMLObject var15 = var14.newXMLObject(Collections.singletonList(var13), (String)null, (String)null, (String)null);
         ...
         var16.add(var37);
         DigestMethod var39 = var14.newDigestMethod("http://www.w3.org/2001/04/xmlenc#sha256", (DigestMethodParameterSpec)null);
         ArrayList var19 = new ArrayList();
         var19.add(var14.newReference("", var39, var16, "", var6));
         var19.add(var14.newReference("#" + var7, var39, Collections.singletonList(var37), "http://uri.etsi.org/01903#SignedProperties", (String)null));
         SignedInfo var20 = var14.newSignedInfo(var37, var14.newSignatureMethod("http://www.w3.org/2001/04/xmldsig-more#rsa-sha256", (SignatureMethodParameterSpec)null), var19);
