...
public class ERY extends ELU<ESC> {
   private LY GBN;
   private BooleanProperty GBO = new SimpleBooleanProperty(this, "changedPropertyHolder", false);
   private boolean GBP;
   @FXML
         ...
         if (this.GBP) {
            ...
            switch (var9) {
               ...
               default:
                  ...
                  break;
               case ExitAndSave:
                  FEN var3 = FCR.getConfirmDataDialog(this.resources.getString("micro.user.save.confirm.title"), (String)null, this.resources.getString("micro.user.save.ok"), this.resources.getString("micro.user.save.cancel"), 500.0, 100.0, this.resources.getString("micro.user.save.info"));
                  switch (var3) {
                     case Confirm:
                        this.GBP = true;
   ...
   public void fxml_handleButton_generalButtonSave(ActionEvent var1) {
      ...
      try {
         ...
         this.GBP = true;
         FEN var2 = FCR.getConfirmDataDialog(this.resources.getString("micro.user.save.confirm.title"), (String)null, this.resources.getString("micro.user.save.ok"), this.resources.getString("micro.user.save.cancel"), 500.0, 100.0, this.resources.getString("micro.user.save.info"));
         switch (var2) {
            case Confirm:
               this.GBP = true;
               this.getProcessAndFinish();
