...
class ETF {
   private TableView<ID> GGA;
   private ResourceBundle GGB;
         ...
         public ObservableValue<String> call(TableColumn.CellDataFeatures<ID, String> var1) {
            ...
            if (var2 != null) {
               ...
               if (((IE)var2).DCD().getValue() != null) {
                  return new SimpleStringProperty(((KM)((IE)var2).DCD().getValue()).getDescription());
               }
   ...
   private void HUY(final TableView<ID> var1) {
      ...
      this.GGD.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ID, String>, ObservableValue<String>>() {
         public ObservableValue<String> call(TableColumn.CellDataFeatures<ID, String> var1) {
            if (var1 != null && var1.getValue() != null && ((ID)var1.getValue()).QRF().getValue() != null) {
               try {
                  return new SimpleStringProperty(((ID)var1.getValue()).QRF().DDZ());
               } catch (FFK var3) {
      ...
      this.GGE.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ID, String>, ObservableValue<String>>() {
         public ObservableValue<String> call(TableColumn.CellDataFeatures<ID, String> var1) {
            return var1 != null && var1.getValue() != null && ((ID)var1.getValue()).HGX().getValue() != null ? new SimpleStringProperty((String)((ID)var1.getValue()).HGX().getValue()) : new SimpleStringProperty();
         }
      });
   ...
   private void HUZ(TableView<ID> var1) {
      ...
      this.GGG.setCellFactory(new ETG<ID, HI>() {
         String getFirstValue(HI var1) {
            return (String)var1.getName().getValue();
         }

         String getSecondValue(HI var1) {
            return (String)var1.getNip().getValue();
         }
      });
      ...
      this.GGH.setCellFactory(new ETG<ID, HI>() {
         String getFirstValue(HI var1) {
            ...
            if (var3 != null) {
               var2.append((String)Optional.ofNullable(var3.getStreet().getValue()).orElse(""));
               var2.append(" ");
               var2.append((String)Optional.ofNullable(var3.getHouseNumber().getValue()).orElse(""));
               String var4 = (String)Optional.ofNullable(var3.getApartmentNumber().getValue()).orElse("");
               if (var4.trim().length() > 0) {
                  var2.append(" ");
                  var2.append(ETF.this.GGB.getString("micro.process.invoices_records.apartmentAbbr"));
                  var2.append(" ");
                  var2.append((String)var3.getApartmentNumber().getValue());
               }
            }
         ...
         String getSecondValue(HI var1) {
            ...
            if (var3 != null) {
               if (var3.getPostalCode() != null && var3.getPostalCode().getValue() != null) {
                  var2.append((String)var3.getPostalCode().getValue());
               }

               var2.append(" ");
               if (var3.getCity() != null && var3.getCity().getValue() != null) {
                  var2.append((String)var3.getCity().getValue());
               }
            }
   ...
   private void HVC(TableColumn<ID, ?> var1, String var2) {
      ...
      var3.getChildren().addAll(new Node[]{var4, var5});
   ...
   private class ETH<_T> extends ETG<_T, EVZ<JR, JR>> {
      ...
      String getFirstValue(EVZ<JR, JR> var1) {
         String var2 = "";
         if (var1 != null && var1.getFirstValue() != null && ((JR)var1.getFirstValue()).getValue() != null) {
            var2 = EOC.HNN((BigDecimal)((JR)var1.getFirstValue()).getValue());
         }
      ...
      String getSecondValue(EVZ<JR, JR> var1) {
         String var2 = "";
         if (var1 != null && var1.getSecondValue() != null && ((JR)var1.getSecondValue()).getValue() != null) {
            var2 = EOC.HNN((BigDecimal)((JR)var1.getSecondValue()).getValue());
         }
