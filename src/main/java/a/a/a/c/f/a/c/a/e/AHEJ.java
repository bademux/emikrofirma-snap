...
public class AHEJ extends AHCF {
   ...
   public EVZ<AHCI, String> AICY(Map<AHDS, AHDT> var1) {
      ...
      try {
         ...
         boolean var2 = false;
         AHDT var3 = (AHDT)var1.get(this.AHWV.getDeclaredFieldType());
         AHDT var4 = (AHDT)var1.get(this.AHWW.getDeclaredFieldType());
         EVZ var5 = null;
         EVZ var6 = null;
         String var7;
         if (var3.AIDH() && var4.AIDH()) {
            ...
            switch (this.AHWU) {
               case AND:
                  var2 = ((AHCI)var5.getFirstValue()).equals(AHCI.SUCCESS) & ((AHCI)var6.getFirstValue()).equals(AHCI.SUCCESS);
                  break;
               case OR:
                  var2 = ((AHCI)var5.getFirstValue()).equals(AHCI.SUCCESS) | ((AHCI)var6.getFirstValue()).equals(AHCI.SUCCESS);
                  break;
               ...
               case NXOR:
                  ...
                  break;
               case IMPLY:
                  boolean var12 = ((AHCI)var5.getFirstValue()).equals(AHCI.SUCCESS);
                  if (var12) {
                     var2 = ((AHCI)var6.getFirstValue()).equals(AHCI.SUCCESS);
                  } else {
                     var2 = true;
                  }
                  break;
