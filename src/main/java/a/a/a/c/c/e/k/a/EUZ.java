...
public class EUZ extends ENL<EVC> implements EMO<IP> {
   ...
   public void HHE() throws FFK {
      ...
      try {
         ...
         ((TextFieldValidated_Text)this.fxml_data_refIdController.fxml_component_main_element).disableProperty().bind(this.GNF.not());
         ...
         ((DatePickerRequired)this.fxml_include_date_boxController.fxml_component_main_element).setDisable(true);
   ...
   public void HHC() {
      ...
      try {
         ...
         ((TextFieldValidated_Text)this.fxml_data_refIdController.fxml_component_main_element).textProperty().bindBidirectional(var2.getRefId().DDG());
   ...
   protected void fxml_handleCash_register_addRowButton(ActionEvent var1) {
      ...
      try {
         ...
         EVA var6 = (EVA)var2.getController();
   ...
   protected void fxml_handleCash_register_RemoveRowButton(ActionEvent var1) {
      ...
      try {
         ...
         IP var2 = (IP)this.fxml_cash_register_items.getSelectionModel().getSelectedItem();
         if (var2 != null) {
            this.GNJ.HYM(var2);
   ...
   private void HYC() throws FFO, FFK {
      ...
      var1.setCreationDate(new JV((LocalDate)((DatePickerRequired)this.fxml_include_date_boxController.fxml_component_main_element).getValue()));
      var1.setRefId(new KE(((TextFieldValidated_Text)this.fxml_data_refIdController.fxml_component_main_element).getText()));
   ...
   private void HYF() {
      if (this.GNE) {
         ...
         if (var1 != null && var2 != null) {
            ...
            ((DatePickerRequired)this.fxml_include_date_boxController.fxml_component_main_element).setValue(var4);
         }

         try {
            JN var7 = this.fxml_include_period_boxController.getPeriod();
            if (var7 != null) {
               boolean var8 = ((EVC)this.getProcess()).HYK(var7);
               IR var5 = ((EVC)this.getProcess()).getReceiptRecord(var7);
               if (var8) {
                  ...
                  this.fxml_include_period_boxController.setValid(true, (String)null);
               }

               if (((LocalDate)((DatePickerRequired)this.fxml_include_date_boxController.fxml_component_main_element).getValue()).isAfter(LocalDate.now())) {
                  ((DatePickerRequired)this.fxml_include_date_boxController.fxml_component_main_element).IEY().set(true);
                  ...
                  ((DatePickerRequired)this.fxml_include_date_boxController.fxml_component_main_element).IEY().set(false);
