...
public class EMB {
   ...
   public synchronized boolean HHQ(String var1, boolean var2, String var3, String var4) throws FFO, FFK {
      ...
      try {
         ...
         LX var17 = (LX)this.FGR.get(var16);
         if (var17 != null) {
   ...
   public synchronized boolean HHR(String var1, String var2) throws FFO, FFK {
      ...
      try {
         if (var1 != null && var1.length() >= 3) {
            ...
            LX var4 = (LX)this.FGR.get(var3);
            if (var4 != null) {
               boolean var5 = false;
               if ((Boolean)var4.getUsePassword().getValue()) {
               ...
               if (!var5) {
                  ...
                  this.FGP = var4;
                  this.FGQ = (String)this.FGP.getUsername().getValue();
   ...
   public synchronized void HHS() throws FFK {
      ...
      try {
         this.FGN.HKY(((String)this.FGP.getUsername().getValue()).toLowerCase());
         this.FGP = null;
         this.FGQ = null;
         this.FGO = null;
         this.FGT = true;
      ...
      try {
         ...
         if (this.FGP != null) {
            if (this.FGP.DFA().getValue() != null) {
               var2 = ((KG)this.FGP.DFA().getValue()).getDescription();
            }
            ...
            if (this.FGP.DEZ().getValue() != null) {
               ...
               var2 = var2 + (String)this.FGP.DEZ().getValue();
            }
         }
   ...
   public LP HHU() throws FFK {
      ...
      LP var2;
      try {
         LP var1 = (LP)this.FGN.HLM(this.FGO, this.FGQ, LP.class);
         if (var1 == null) {
            var1 = new LP();
   ...
   public LY HHW(Integer var1) throws FFK {
      ...
      LY var3;
      try {
         LY var2 = (LY)this.FGN.HLN(this.FGO, this.FGQ, LY.class, var1);
         var3 = var2;
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   private void HIC(JN var1, JH var2) throws FFK, FFO {
      ...
      try {
         EVZ var3 = this.FGN.HLQ(this.FGO, (FDL)null, (Integer)null, (Integer)null, var1.DDN(), var2);
         JI var4;
         if (var3 != null && var3.getSecondValue() != null && ((List)var3.getSecondValue()).size() != 0) {
            ...
            this.HII(FDO.insert, var4, (JF)null);
         }
      } finally {
         EXF.getInstance().ICP();
      }
      ...
      try {
         ...
         switch (var1) {
            ...
            case update:
               ...
               if (var7) {
                  var8 = this.FGN.ROB(this.FGO, QSW.ACTIVE, (FDL)null, (Integer)null, (Integer)null, var4, (IB)null, (IA)null, (KE)null, (KA)null, (KA)null, (EVZ)null, (EVZ)null, (String)null);
                  EVZ var20 = this.FGN.HLP(this.FGO, (FDL)null, (Integer)null, (Integer)null, var4, (IQ)null);
                  EVZ var19 = this.FGN.ROC(this.FGO, QSW.ACTIVE, (FDL)null, (Integer)null, (Integer)null, var4, (QSR)null, (QSQ)null, (KE)null, (KA)null, (KA)null, (EVZ)null, (EVZ)null, (String)null);
                  LY var11 = this.HHV();
               ...
               break;
            case delete:
               var8 = this.FGN.HLV(this.FGO, (FDL)null, (Integer)null, (Integer)null, var4, (IH)null);
               ...
               this.FGN.HMH(var1, this.FGO, var2, (JF)null);
               break;
            default:
   ...
   public String getReferenceByPatternDemo(Date var1, String var2, boolean var3) throws FFK {
      ...
      try {
         ...
         Map var6 = (Map)this.FGS.get(var5);
   ...
   public List<EVZ<String, String>> getReferenceByPatternDemoSequences(Date var1) throws FFK {
      ...
      try {
         ...
         Map var13 = (Map)this.FGS.get(var2);
         if (var13 != null) {
   ...
   public int HJB(String var1, String var2) {
      ...
      LX var4;
      try {
         if ((Boolean)this.FGP.getUsePassword().getValue()) {
            var4 = (LX)this.FGR.get(var3);
      ...
      if (this.FGN.HMX(var3) != null) {
         EXF.getInstance().ICA((Object)"OldDB was not renamed");
         return 2;
      } else {
         var4 = null;
         String var5 = null;
         ...
         try {
            ...
            var6 = this.FGN.QPQ(this.FGO, var13, var3, var5, (File)null);
            if (var6 == null) {
               this.FGN.HLE();
               this.FGN.HKV(var5);
               return 3;
   ...
   public int HJC() {
      ...
      if (this.FGN.HMX(var1) != null) {
         ...
         try {
            var3 = var1 + "_NEW";
            var4 = this.FGN.QPQ(this.FGO, (FFF)var2, var1, var3, (File)null);
            if (var4 == null) {
               this.FGN.HLE();
               this.FGN.HKV(var3);
               return 3;
            ...
            var5 = new LX(this.FGP.getUsername(), this.FGP.getLoginType(), new JS(false), (JT)null, (JT)null, true);
      ...
      try {
         label228: {
            ...
            if (var1.exists() && var1.getName().endsWith(".zip")) {
               ...
               var2 = Paths.get(EVW.GPW, var3).toFile();
               ...
               if (var4 != null && var4.length == 2) {
                  ...
                  if (var5 != null && var5.isFile() && var5.getName().endsWith(".db") && var6 != null && var6.isFile() && var6.getName().endsWith(".db")) {
                     LX var7 = new LX(this.FGP.getUsername(), this.FGP.getLoginType(), new JS(false), (JT)null, (JT)null, true);
