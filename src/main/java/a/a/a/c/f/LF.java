...
public abstract class LF extends KX<XMLGregorianCalendar> {
   @XmlTransient
   private ObjectProperty<LocalDate> APT;
   ...
   public Date getValueDate() {
      return super.getValue() == null ? null : ((XMLGregorianCalendar)super.getValue()).toGregorianCalendar().getTime();
   }
   ...
   public int compareTo(KX<XMLGregorianCalendar> var1) {
      return var1 != null && var1.getValue() != null ? ((XMLGregorianCalendar)var1.getValue()).compare((XMLGregorianCalendar)this.getValue()) : -1;
   }
   ...
   private class LG extends SimpleObjectProperty<LocalDate> {
      ...
      public LocalDate get() {
         return this.APS.getValue() != null ? ((XMLGregorianCalendar)this.APS.getValue()).toGregorianCalendar().toZonedDateTime().toLocalDate() : null;
      }
