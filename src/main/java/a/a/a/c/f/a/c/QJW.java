...
public class QJW implements QST {
   ...
   public HI getContractor() {
      ...
      try {
         if (this.QLH == null) {
            this.QLH = (HI)this.QLG.getModelBaseElementWithIdObject();
         }
   ...
   public String getName() {
      if (this.QWK == null) {
         this.QWK = (String)this.QLG.getValue("business_contractorName");
      }
   ...
   public String getNip() {
      if (this.QWL == null) {
         this.QWL = (String)this.QLG.getValue("business_contractorNIP");
      }
