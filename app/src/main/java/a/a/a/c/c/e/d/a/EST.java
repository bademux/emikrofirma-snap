...
public class EST extends ENN<ESX> {
    ...
    public void HHC() {
        ...
        try {
            ...
            this.GEP = false;
            ESX var1 = this.HHG();
            if (this.GER != null && !Mode.NEW.equals(this.GER)) {
                if (Mode.VIEW.equals(this.GER)) {
                    this.GEO.set(true);
                    ...
                    Nip var4 = this.GEQ.getIssuerNumber() != null ? this.GEQ.getIssuerNumber().DEJ() : null;
