...
public class ValueContainer3<_FIRST, _SECOND, _THIRD> extends ValueContainer2<_FIRST, _SECOND> {
    protected _THIRD GQF;

    public ValueContainer3() {
        this(null, null, null);
    }

    public ValueContainer3(_FIRST var1, _SECOND var2, _THIRD var3) {
        super(var1, var2);
        this.GQF = var3;
    }
    ...
    public boolean equals(Object var1) {
        if (this == var1) {
            ...
            ValueContainer3 var2 = (ValueContainer3) var1;
            if (this.GQF == null) {
