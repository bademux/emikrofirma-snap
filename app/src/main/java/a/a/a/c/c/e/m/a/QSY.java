...
public class QSY {
    ...
    public void setupDefaults(ResourceBundle var1) {
        ...
        try {
            ...
            var2 = (String) var3.getConfigurationPropertyOrDefault(ConfigurationProperty.CalculationMethod).DEY().getValue();
        } catch (FFK var7) {
            var2 = (String) QJZ.getDefaultConfigurationProperty(ConfigurationProperty.CalculationMethod).DEY().getValue();
        }
