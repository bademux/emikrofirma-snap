...
public class EVJ extends QVI {
   ...
   public List<EPA<HY>> getInvoices(ENP var1, Integer var2, Integer var3, String var4, String var5) throws FFK, FFO {
      ...
      try {
         ...
         switch (var1) {
            case ONLY_EMPTY:
               var6 = new IU(HY.class, QSW.ACTIVE, JN.AOE, IB.SELL, (IA)null, (KE)null, (String)null, FDL.DESC);
               break;
            case ONLY_CANCELED:
               var6 = new IU(HY.class, QSW.CANCELED, (JN)null, IB.SELL, (IA)null, (KE)null, (String)null, FDL.DESC);
               break;
            case WITHOUT_EMPTY:
               var6 = new IU(HY.class, QSW.ACTIVE, new JN(var2, var3), IB.SELL, (IA)null, (KE)null, var4, FDL.DESC);
               break;
            case ALL:
            default:
               var6 = new IU(HY.class, (QSW)null, (JN)null, IB.SELL, (IA)null, (KE)null, var4, FDL.DESC);
         }
   ...
   public LY getUserDataForInvoice(HN<?> var1) throws FFK {
      ...
      LY var4;
      try {
         JB var2 = new JB(LY.class, (Integer)var1.DBC().getValue());
   ...
   public File getWorkingDir() {
      ...
      File var7;
      try {
         File var1 = new File((String)this.GPH.DEY().getValue());
         boolean var2 = var1.mkdirs();
         if (!var2) {
            LS var3 = (LS)QJZ.getDefaultConfigurationProperty(FCQ.WorkingDir);
            var1 = new File((String)var3.DEY().getValue());
         }
   ...
   public List<EZT> getRangesWhereSettled(String var1) {
      ...
      ArrayList var4;
      try {
         IY var3 = new IY(JF.class, (JN)null, JH.VAT, (Enum)null);
         ...
         while(var5.hasNext()) {
            ...
            if (var7.getSettlementStatus().equals(JG.SETTLED)) {
               LocalDate var8 = LocalDate.of((Integer)var7.getPeriod().getYear().getValue(), (Integer)var7.getPeriod().getMonth().getValue(), 1);
               LocalDate var9 = LocalDate.of((Integer)var7.getPeriod().getYear().getValue(), (Integer)var7.getPeriod().getMonth().getValue(), var8.lengthOfMonth());
   ...
   public boolean RKZ(JN var1, String var2) throws FFK, FFO {
      ...
      boolean var5;
      try {
         IU var3 = new IU(HY.class, (QSW)null, var1, IB.SELL, (IA)null, new KE(var2), (String)null);
