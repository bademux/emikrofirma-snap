...
public class EQB {
   ...
   private void HPU(EQD var1, Double var2) {
      ...
      try {
         this.HPV(var1, var2, (String)null);
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public EQC HPW() {
      ...
      try {
            ...
            switch (this.FVS) {
               ...
               case INIT_SERVER_ERROR:
                  try {
                     ...
                     EWK var47 = EWH.IBA(var40, (EWX)null, new EWI());
                     ...
                     if (var47.getStatus() == 200) {
                        ...
                        if (var47.getStatus() == 400) {
                           ...
                           EXF.getInstance().ICA((Object)("Initial call for file [" + this.FVQ.getDeclarationFile() + "] failed! " + var55));
                           ...
                           this.FVR = EQB.EQC.CAN_BE_RESTARTED;
                           this.FVQ.setDeclarationStatus(HL.RETRY);
                           EXF.getInstance().ICA((Object)("Initial call for file [" + this.FVQ.getDeclarationFile() + "] failed!"));
                        }
                     }
                        ...
                        for(int var13 = 0; var13 < var38.size(); ++var13) {
                           ...
                           switch (var19) {
                              ...
                              case FAIL:
                                 var58 = false;
                                 var59 = false;
                                 EXF.getInstance().ICA((Object)("Upload process [BlobUpload] [" + var16 + "] [" + var19 + "] failed! " + var20));
                                 var12.append(var20).append(System.lineSeparator());
                                 break;
                              case CAN_BE_RESTARTED:
                                 var58 = false;
                                 EXF.getInstance().ICA((Object)("Upload process [BlobUpload] [" + var16 + "] [" + var19 + "] failed, but can be restarted. " + var20));
                                 var12.append(var20).append(System.lineSeparator());
                                 break;
                              case INIT:
                              case RUNNING:
                                 EXF.getInstance().ICA((Object)("Not supposed to happen in this place [" + var16 + "] [" + var19 + "]"));
                           }
                        }
               ...
               case FINISH_SERVER_ERROR:
                  try {
                     ...
                     for(int var48 = 0; var48 < var38.size(); ++var48) {
                        ...
                        var44.add((String)var5.get("BlobName"));
                     }
                     ...
                     EWK var6 = EWH.IBA(var51, (EWX)null, new EWI());
                     ...
                     if (var6.getStatus() == 200) {
                        ...
                        if (var6.getStatus() == 400) {
                           ...
                           this.FVR = EQB.EQC.FAIL;
                           EXF.getInstance().ICA((Object)("Finish call for file [" + this.FVQ.getDeclarationFile() + "] failed!"));
               ...
               case STATUS_FAILED:
                  try {
                     ...
                     EWK var2 = EWH.IBA(var1, (EWX)null, new EWI());
                     ...
                     if (var2.getStatus() == 200) {
                        ...
                        if (var2.getStatus() == 400) {
                           ...
                           this.FVR = EQB.EQC.FAIL;
                           EXF.getInstance().ICA((Object)("Status call for session entry [" + this.FVQ.getId() + "] failed! " + var46.toString()));
                           ...
                           this.FVR = EQB.EQC.CAN_BE_RESTARTED;
                           EXF.getInstance().ICA((Object)("Status call for session entry [" + this.FVQ.getId() + "] failed!"));
                        }
                     }
         ...
         switch (this.FVR) {
            case SUCCESS:
               String var42 = String.valueOf((Long)this.FVQ.getStatusResponseJSONObject().get("Code"));
         ...
         this.FVR = EQB.EQC.FAIL;
         EXF.getInstance().ICA((Throwable)var34);
         FCR.IGP("", (Throwable)var34, false);
         throw new FFI(var34);
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   private static EQC QIV(AGWN var0) throws FFK, FFO {
      ...
      try {
         ...
         EWK var6 = EWH.MXF(var2, (EWX)null, new EWI(), var5);
         ...
         if (var6.getStatus() == 200) {
            ...
            if (var6.getStatus() == 400) {
               ...
               var1 = EQB.EQC.FAIL;
               EXF.getInstance().ICA((Object)("Status call for session entry [" + var0.getId() + "] failed! " + var20.toString()));
            } else if (var6.getStatus() == 500) {
               var0.setStatusResponseJSON((JSONObject)var6.getContent());
               var7 = (JSONObject)var6.getContent();
               var20 = new StringBuilder();
               ...
               var1 = EQB.EQC.FAIL;
               EXF.getInstance().ICA((Object)("Status call for session entry [" + var0.getId() + "] failed!"));
            }
         }
   ...
   private static EQC QIW(AGWN var0) throws FFK, FFO {
      ...
      try {
         ...
         var2.getHeaderFields().put("Accept", EWQ.JSON.getMimeType());
         EXF.getInstance().ICE("HttpSenderRequest Status " + var2);
         EWK var3 = EWH.IBA(var2, (EWX)null, new EWI());
         ...
         if (var3.getStatus() == 200) {
            ...
            if (var3.getStatus() == 400) {
               ...
               var1 = EQB.EQC.FAIL;
               EXF.getInstance().ICA((Object)("Status call for session entry [" + var0.getId() + "] failed! " + var17.toString()));
   ...
   private EVZ<EQC, String> HPY(JSONObject var1, AGXD var2, EWX var3) throws FFK {
      ...
      try {
         ...
         for(int var6 = 0; var6 < var14.size(); ++var6) {
            ...
            var4.put((String)var7.get("Key"), (String)var7.get("Value"));
         }
         ...
         EWK var16 = EWH.IAX(var15, var3, (EWX)null, new EWU());
   ...
   public EQC MXA() {
      ...
      try {
         ...
         try {
            ...
            var8.add(new EWC("<JPKMicro>", var10, new Long((long)var9.length)));
            var8.add(new EWC("<DokumentJPK>", var11, var3.length()));
            double var12 = 0.2;
            double var14 = 0.81;
            this.HPU(EQB.EQD.KD_SEND_START, var12);
            EWK var16 = EWH.MXE(EWP.POST, FEK.MWU, "esb2.mf.gov.pl", 5064, "/jpkmicro/UploadJPK", "jpkmicro", var8, (EWX)null, (EWX)null, new MML(), var7);
            ...
            if (var16.getStatus() == 200) {
               ...
               if (var17.containsKey("ReferenceNumber")) {
                  ...
                  EXF.getInstance().ICA((Object)("Initial call for file [" + var4 + "] succeded! " + var19));
               } else {
                  ...
                  var32.append(var17.get("Code")).append(" - ");
                  var32.append(var17.get("Message")).append(" - ");
                  var32.append(var17.get("Errors")).append(" - ");
                  var32.append(var17.get("RequestId"));
                  String var20 = var32.toString();
                  ...
                  EXF.getInstance().ICA((Object)("Initial call for file [" + var4 + "] failed! " + var20));
               }
            } else {
               this.HPU(EQB.EQD.KD_SEND_FAILED, var14);
               this.FVR = EQB.EQC.FAIL;
               this.FVQ.setDeclarationStatus(HL.FAILURE);
               EXF.getInstance().ICA((Object)("Request status is " + var16.getStatus()));
               var1 = true;
            }
   ...
   private byte[] MXB(MME<Boolean, String, String, String, LocalDate, BigDecimal, String> var1) throws FFO, FFK {
      ...
      try {
         ...
         if ((Boolean)var1.getFirstValue()) {
            var4.setPESEL((String)var1.getSecondValue());
         } else {
            var4.setNIP((String)var1.getSecondValue());
         }

         var4.setImiePierwsze((String)var1.getThirdValue());
         var4.setNazwisko((String)var1.getFourthValue());
         var4.setDataUrodzenia(this.MXC((LocalDate)var1.getFifthValue()));
         var4.setKwota((BigDecimal)var1.getSixthValue());
         var3.setEmail((String)var1.getSeventhValue());
         FEO var5 = new FEO(false, false, StandardCharsets.UTF_8, new Class[]{JPKMicro.class});
