...
import a.a.a.c.f.b.c.JQ;
import a.a.a.c.f.b.c.JS;
import a.a.a.c.f.b.c.JU;
import a.a.a.c.f.b.c.KA;
import a.a.a.c.f.b.c.KF;
import a.a.a.c.f.b.c.KO;
import a.a.a.c.f.b.c.KS;
...
public class HI extends IL implements Comparable<HI> {
   private KO AIT;
   private KA AIU;
   private KF AIV;
   private JQ AIW;
   ...
   public int compareTo(HI var1) {
      return ((String)this.AIT.getValue()).compareToIgnoreCase((String)var1.AIT.getValue());
   }
   ...
   public boolean AICE() {
      return (Boolean)this.AHRM.getValue();
   }
