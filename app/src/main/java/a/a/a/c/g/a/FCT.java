...
public class FCT {
    ...
    private abstract static class FCU<_T> {
        ...
        public void IGW(_T var1, boolean var2) {
            this.setGraphicDelegate(null);
            this.setTextDelegate(null);
            this.setTooltipDelegate(null);
            this.setBackgroundDelegate(null);
            if (!var2) {
                this.setContextMenuDelegate(null);
                if (var1 instanceof Double) {
                    ...
                    if (var10) {
                        ...
                        this.setBackgroundDelegate(new Background(new BackgroundFill(Color.RED, CornerRadii.EMPTY, Insets.EMPTY)));
                    ...
                    if (var1 instanceof File) {
                        ...
                        if (var1 instanceof FFM) {
                                        ...
                                        if (var3 != null) {
                                            ...
                                            try {
                                                ...
                                                while (var8.hasNext()) {
                                                    ...
                                                    var4.write(("V" + var5 + var6++ + var5 + var9.getLocalizedMessage() + System.lineSeparator()).getBytes(StandardCharsets.UTF_8));
                                                    var4.flush();
                                                }
                            ...
                            this.setBackgroundDelegate(new Background(new BackgroundFill(Color.GREY, CornerRadii.EMPTY, Insets.EMPTY)));
