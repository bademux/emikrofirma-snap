         ...
         TableCell var2 = new TableCell<_T, Object>() {
            public void startEdit() {
               if (EOT.this.FNY) {
                  ...
                  if (var1 instanceof LH) {
                     ...
                     final ChangeListenerFocus var5 = new ChangeListenerFocus() {
                        ...
                        public Object updateAndReturnObject() {
                           var3.setValue((_T)var4.getSelectionModel().getSelectedItem());
                           return var3;
                        }
                     };
                  ...
                  } else if (var1 instanceof LL) {
                     final LL var9 = (LL)var1;
                  ...
                  } else if (var1 instanceof KX) {
                     String var10 = null;
                     final KX var14 = (KX)var1;
