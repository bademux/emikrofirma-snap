...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="sum_net_before_correction" />
  <xsl:param name="sum_tax_before_correction" />
  <xsl:param name="sum_brut_before_correction" />
  <xsl:param name="correction_reason" />
  <xsl:param name="ref_id_old" />
  <xsl:param name="creation_date_old" />
  <xsl:param name="to_pay_or_to_return_name" />
  <xsl:param name="diff_sum_net" />
  <xsl:param name="diff_sum_tax" />
  <xsl:param name="diff_sum_brut" />
  <xsl:param name="unit_price" />
  <xsl:param name="unit_price_before_correction" />
    ...
    <fo:root>
      ...
      <fo:page-sequence master-reference="A4-portrait" id="page"
        ...
        <fo:flow flow-name="xsl-region-body">
								...
								<fo:block>
									<fo:block font-size="14">
										<fo:inline font-weight="bold">
											<xsl:value-of select="resources:getString('micro.process.invoice_sale_new.Print.InvoiceCorrection')"/>
										</fo:inline>
									</fo:block>
									<fo:block wrap-option="wrap" font-size="14">
									...
									<fo:block wrap-option="wrap">
										<xsl:value-of select="resources:getString('micro.process.invoice_sale_new.Print.Relate')"/>
									</fo:block>
									<fo:block>
										...
										<xsl:value-of select="resources:getString('micro.process.invoice_sale_new.Print.Nr')"/>
										<xsl:value-of select="' '" />
										<xsl:value-of select="$ref_id_old" />
									</fo:block>
									<fo:block>
										<xsl:value-of select="resources:getString('micro.process.invoice_sale_new.Print.CreationDate')"/>
										<xsl:value-of select="' '" />
										<xsl:value-of select="$creation_date_old"/>
									...
									<fo:block wrap-option="wrap">
										<fo:inline font-weight="bold">
											<xsl:value-of select="resources:getString('micro.process.invoice_sale_new.Print.CorrectionReason')"/>
										</fo:inline>
									</fo:block>
									<fo:block>
										<xsl:value-of select="$correction_reason" />
									</fo:block>
									<fo:block>
										 <fo:leader />
									</fo:block>
			...
			<fo:block>
				<xsl:value-of select="resources:getString('micro.process.invoice_sale_new.Print.ElementsBeforeCorrection')"/>
            </fo:block>
			<fo:block>
				<fo:leader />
            </fo:block>
			<fo:table font-size="7" table-omit-footer-at-break="true">
				...
				<fo:table-header font-weight="bold" border-top="solid black"
					...
					<fo:table-row border-bottom="solid black"
						...
						<fo:table-cell border-right="solid black"
							...
							<fo:block>
								<xsl:value-of
									select="$unit_price_before_correction" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border-right="solid black"
							margin-top="2mm" margin-bottom="2mm">
				...
				<fo:table-body border-left="solid black">
					<xsl:apply-templates select="invoiceSellElementsBeforeCorrection" />
				</fo:table-body>
			</fo:table>
			<fo:table font-size="7" table-omit-footer-at-break="true">
				...
				<fo:table-header font-weight="bold" border-top="solid black"
					...
					<fo:table-row border-bottom="solid black"
						...
						<fo:table-cell border-right="solid black"
							...
							<fo:block margin="0.5mm">
								<xsl:value-of
									select="$sum_net_before_correction" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border-right="solid black"
							margin-top="2mm" margin-bottom="2mm" text-align="right">
							<fo:block margin="0.5mm">
								<xsl:value-of
									select="$sum_tax_before_correction"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border-right="solid black"
							margin-top="2mm" margin-bottom="2mm" text-align="right">
							<fo:block margin="0.5mm">
								<xsl:value-of
									select="$sum_brut_before_correction"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-header>
			...
			<fo:block>
				<xsl:value-of select="resources:getString('micro.process.invoice_sale_new.Print.ElementsAfterCorrection')"/>
            </fo:block>
			<fo:block>
				<fo:leader />
            </fo:block>
		    <fo:table font-size="7" table-omit-footer-at-break="true">
				...
				<fo:table-header font-weight="bold" border-top="solid black"
					...
					<fo:table-row border-bottom="solid black"
						display-align="center" text-align="center">
						<fo:table-cell border-right="solid black" margin-top="2mm" margin-bottom="2mm">
							<fo:block margin="0.5mm">
								<xsl:value-of
									select="resources:getString('micro.process.invoice_sale_new.Print.InvoiceElementNr')" />
							</fo:block>
							...
							<fo:block>
								<fo:block>
									<fo:inline font-weight="bold" font-size="11">
										<xsl:value-of select="$to_pay_or_to_return_name"/>
										<xsl:value-of select="' '" />
  ...
  <xsl:template match="invoiceSellElements">
	...
	<xsl:template match="invoiceSellElementsBeforeCorrection">
		<fo:table-row border-bottom="solid black">
			<fo:table-cell border-right="solid black" text-align="center">
				<fo:block margin="0.5mm">
					<xsl:value-of select="nr"/>
