...
import a.a.a.c.c.d.d.ENT;
import a.a.a.c.c.d.d.ENZ;
import a.a.a.c.c.d.d.EOG;
import a.a.a.c.c.d.d.EOI;
import a.a.a.c.c.d.d.EOJ;
...
public class ETZ extends EMD {
   ...
   private Node HWI(int var1) {
      ...
      try {
         ...
         this.HWJ();
         this.setTableHeight();
         var2 = new VBox(new Node[]{this.fxml_declaration_list_declaration_table});
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public HJ getSelectedDeclaration() {
      return (HJ)this.fxml_declaration_list_declaration_table.getSelectionModel().getSelectedItem();
   }
   ...
   protected void fxml_handleButton_declaration_list_track_jpk_status(ActionEvent var1) {
      ...
      try {
         final QGX var2 = new QGX(((TextFieldValidated_Text)this.fxml_declaration_list_jpk_ref_idController.fxml_component_main_element).getText());
         Integer var3 = this.QHT.HXA(JN.AOE, HM.JPK, AGWW.STATUS_TRACKER);
         var2.FJI().setValue(var3);
         final MTI var4 = new MTI(null);
         final MTI var5 = new MTI(new Boolean(false));
               ...
               try {
                  if (var4.getObject() == null) {
                     if ((Boolean)var5.getObject()) {
                        ...
                        ((TextFieldValidated_Text)ETZ.this.fxml_declaration_list_jpk_ref_idController.fxml_component_main_element).setText("");
                     } else {
