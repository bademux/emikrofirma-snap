...
public class JN extends IJ implements Comparable<JN> {
   public static final transient JN AOE = new JN(0, 0);
   private JY AOF;
   private JY AOG;
   @XmlTransient
   private ObjectProperty<LocalDate> AOH;
   @XmlTransient
   private ObjectProperty<JN> AOI;
   ...
   private JN(EVZ<Integer, Integer> var1) {
      this(new JY((Integer)var1.getFirstValue()), new JY((Integer)var1.getSecondValue()));
      EXF.getInstance().ICQ();
   }
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         } else if (!this.AOF.equals(var2.AOF)) {
            return false;
         }
   ...
   public int compareTo(JN var1) {
      if (this.equals(var1)) {
         ...
         if ((Integer)this.AOF.getValue() > (Integer)var1.AOF.getValue()) {
            return -1;
         } else if ((Integer)this.AOF.getValue() < (Integer)var1.AOF.getValue()) {
            return 1;
         } else {
            return (Integer)this.AOG.getValue() > (Integer)var1.AOG.getValue() ? -1 : 1;
         }
      } else {
         return -1;
      }
