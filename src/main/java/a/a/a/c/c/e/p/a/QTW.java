...
public class QTW extends EMD implements EMO<QSI>, EYR {
   ...
   private BooleanProperty RCD = new SimpleBooleanProperty(false);
   private BooleanProperty RCE = new SimpleBooleanProperty(false);
   private BooleanProperty RCF = new SimpleBooleanProperty(false);
   private ListProperty<QSI> RCG = new SimpleListProperty();
   private BooleanProperty RCH = new SimpleBooleanProperty(false);
   private BooleanProperty RCI = new SimpleBooleanProperty(false);
   private QTY RCJ;
   ...
   public void initialize() {
      ...
      try {
         ((TextFieldValidated_Text)this.fxml_include_invoiceRefNumber_boxController.fxml_component_main_element).editableProperty().bind(this.RBY);
         ((DatePickerRequired)this.fxml_include_issueDate_boxController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((DatePickerRequired)this.fxml_include_invoicingDate_boxController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_streetController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_house_numberController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_apartment_numberController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((TextFieldValidated_PostalCode)this.fxml_purchase_contractor_postal_codeController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_cityController.fxml_component_main_element).disableProperty().bind(this.RBY.not());
         this.fxml_other_purchase_elements_table.disableProperty().bind(this.RBY.not());
         ((TextAreaRequired)this.fxml_other_purchase_remarksController.fxml_component_main_element).editableProperty().bind(this.RBY);
         ((ComboBoxRequired)this.fxml_other_purchase_new_other_element_typeController.fxml_component_main_element).disableProperty().bind(this.RBY.not().or(this.RCD));
         ((ComboBoxRequired)this.fxml_other_purchase_new_other_element_typeController.fxml_component_main_element).setCellFactory(new EOQ());
         ((ComboBoxRequired)this.fxml_other_purchase_new_other_element_typeController.fxml_component_main_element).setButtonCell((ListCell)((ComboBoxRequired)this.fxml_other_purchase_new_other_element_typeController.fxml_component_main_element).getCellFactory().call(null));
         ...
         this.RCH.bind(((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getEditor().textProperty().isNotNull().and(((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getEditor().textProperty().isNotEqualTo("")).or(((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().textProperty().isNotNull().and(((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().textProperty().isNotEqualTo("")).or(((TextFieldValidated_Text)this.fxml_purchase_contractor_streetController.fxml_component_main_element).textProperty().isNotNull().and(((TextFieldValidated_Text)this.fxml_purchase_contractor_streetController.fxml_component_main_element).textProperty().isNotEqualTo("")).or(((TextFieldValidated_Text)this.fxml_purchase_contractor_house_numberController.fxml_component_main_element).textProperty().isNotNull().and(((TextFieldValidated_Text)this.fxml_purchase_contractor_house_numberController.fxml_component_main_element).textProperty().isNotEqualTo("")).or(((TextFieldValidated_Text)this.fxml_purchase_contractor_apartment_numberController.fxml_component_main_element).textProperty().isNotNull().and(((TextFieldValidated_Text)this.fxml_purchase_contractor_apartment_numberController.fxml_component_main_element).textProperty().isNotEqualTo("")).or(((TextFieldValidated_PostalCode)this.fxml_purchase_contractor_postal_codeController.fxml_component_main_element).textProperty().isNotNull().and(((TextFieldValidated_PostalCode)this.fxml_purchase_contractor_postal_codeController.fxml_component_main_element).textProperty().isNotEqualTo("")).or(((TextFieldValidated_Text)this.fxml_purchase_contractor_cityController.fxml_component_main_element).textProperty().isNotNull().and(((TextFieldValidated_Text)this.fxml_purchase_contractor_cityController.fxml_component_main_element).textProperty().isNotEqualTo("")))))))));
         ...
         ((DatePickerRequired)this.fxml_include_invoicingDate_boxController.fxml_component_main_element).valueProperty().addListener(new QUA(this));
         ((DatePickerRequired)this.fxml_include_issueDate_boxController.fxml_component_main_element).valueProperty().addListener(new ROS());
   ...
   private void RMB() {
      ...
      try {
         ((TextFieldValidated_Text)this.fxml_include_invoiceRefNumber_boxController.fxml_component_main_element).textProperty().bindBidirectional(this.RBW.RIR().DDG());
         ...
         this.RMD();
         ((DatePickerRequired)this.fxml_include_issueDate_boxController.fxml_component_main_element).valueProperty().bindBidirectional(this.RBW.RIS().DEC());
         ((DatePickerRequired)this.fxml_include_invoicingDate_boxController.fxml_component_main_element).valueProperty().bindBidirectional(this.RBW.RJO().DEC());
         ((TextAreaRequired)this.fxml_other_purchase_remarksController.fxml_component_main_element).textProperty().bindBidirectional(this.RBW.RJA().DDG());
   ...
   private void RMC() {
      ...
      try {
         ...
         this.RCJ = null;
         this.HHD(((TextFieldValidated_Text)this.fxml_include_invoiceRefNumber_boxController.fxml_component_main_element).textProperty(), this.RBW.RIR().DDG());
         ...
         this.RME();
         ((DatePickerRequired)this.fxml_include_issueDate_boxController.fxml_component_main_element).valueProperty().unbindBidirectional(this.RBW.RIS().DEC());
         ((DatePickerRequired)this.fxml_include_invoicingDate_boxController.fxml_component_main_element).valueProperty().unbindBidirectional(this.RBW.RJO().DEC());
         this.HHD(((TextAreaRequired)this.fxml_other_purchase_remarksController.fxml_component_main_element).textProperty(), this.RBW.RJA().DDG());
   ...
   private void RMD() {
      ...
      try {
         ...
         ((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getEditor().textProperty().bindBidirectional(var1.DAI().DDG());
         ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().textProperty().bindBidirectional(var1.DAJ().DDG());
         JJ var2 = var1.DAM();
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_streetController.fxml_component_main_element).textProperty().bindBidirectional(var2.DDA().DDG());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_house_numberController.fxml_component_main_element).textProperty().bindBidirectional(var2.DDB().DDG());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_apartment_numberController.fxml_component_main_element).textProperty().bindBidirectional(var2.DDC().DDG());
         ((TextFieldValidated_PostalCode)this.fxml_purchase_contractor_postal_codeController.fxml_component_main_element).textProperty().bindBidirectional(var2.DDD().DDG());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_cityController.fxml_component_main_element).textProperty().bindBidirectional(var2.DCZ().DDG());
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   private void RME() {
      ...
      try {
         HI var1 = this.RBW.RJM();
         ((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getEditor().textProperty().unbindBidirectional(var1.DAI().DDG());
         ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().textProperty().unbindBidirectional(var1.DAJ().DDG());
         JJ var2 = var1.DAM();
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_streetController.fxml_component_main_element).textProperty().unbindBidirectional(var2.DDA().DDG());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_house_numberController.fxml_component_main_element).textProperty().unbindBidirectional(var2.DDB().DDG());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_apartment_numberController.fxml_component_main_element).textProperty().unbindBidirectional(var2.DDC().DDG());
         ((TextFieldValidated_PostalCode)this.fxml_purchase_contractor_postal_codeController.fxml_component_main_element).textProperty().unbindBidirectional(var2.DDD().DDG());
         ((TextFieldValidated_Text)this.fxml_purchase_contractor_cityController.fxml_component_main_element).textProperty().unbindBidirectional(var2.DCZ().DDG());
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   private void RMH() {
      ...
      try {
         ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getItems().clear();
         ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).setValue(null);
         ((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getItems().clear();
         ((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).setValue(null);
   ...
   private void setDefault() {
      ...
      try {
         ((ComboBoxRequired)this.fxml_other_purchase_new_other_element_typeController.fxml_component_main_element).setValue(null);
         ((DatePickerRequired)this.fxml_include_issueDate_boxController.fxml_component_main_element).setValue(LocalDate.now());
         ((DatePickerRequired)this.fxml_include_invoicingDate_boxController.fxml_component_main_element).setValue(LocalDate.now());
      } finally {
         EXF.getInstance().ICP();
      }
      ...
      try {
         if (var1 != null) {
            ...
            if (!var3.equalsIgnoreCase((String)var2.DAJ().getValue())) {
               ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().setText((String)var2.getNip().getValue());
               ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().positionCaret(((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().getText().length());
            } else {
               ((ComboBoxValidated_NIP)this.fxml_purchase_contractor_nipController.fxml_component_main_element).getEditor().setText("");
            }

            ((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getEditor().setText((String)var2.getName().getValue());
            ((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getEditor().positionCaret(((ComboBoxValidated_ContractorName)this.fxml_purchase_contractor_nameController.fxml_component_main_element).getEditor().getText().length());
            JJ var4 = var2.DAM();
            ((TextFieldValidated_Text)this.fxml_purchase_contractor_streetController.fxml_component_main_element).setText((String)var4.getStreet().getValue());
            ((TextFieldValidated_Text)this.fxml_purchase_contractor_house_numberController.fxml_component_main_element).setText((String)var4.getHouseNumber().getValue());
            ((TextFieldValidated_Text)this.fxml_purchase_contractor_apartment_numberController.fxml_component_main_element).setText((String)var4.getApartmentNumber().getValue());
            ((TextFieldValidated_PostalCode)this.fxml_purchase_contractor_postal_codeController.fxml_component_main_element).setText((String)var4.getPostalCode().getValue());
            ((TextFieldValidated_Text)this.fxml_purchase_contractor_cityController.fxml_component_main_element).setText((String)var4.getCity().getValue());
         }
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   private void fxml_handleButton_other_purchase_new_add_new_element(ActionEvent var1) {
      ...
      try {
         ...
         var4.setScene(var5);
         QTX var6 = (QTX)var2.getController();
   ...
   public void RMJ(QTX var1) {
      if (var1.RMN()) {
         QSI var2 = new QSI();
         var2.RJE().setValue(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_netController.fxml_component_main_element).getNumber());
         var2.RJE().setAllowNegative(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_netController.fxml_component_main_element).IFG());
         var2.RJE().setAllowOnlyNegative(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_netController.fxml_component_main_element).RHT());
         var2.RJE().setScale(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_netController.fxml_component_main_element).getMaxLength());
         var2.RJE().setPresicion(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_netController.fxml_component_main_element).getMaximumFractionDigits());
         ...
         var2.RJF().setValue(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_taxController.fxml_component_main_element).getNumber());
         var2.RJF().setAllowOnlyNegative(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_taxController.fxml_component_main_element).RHT());
         var2.RJF().setAllowNegative(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_taxController.fxml_component_main_element).IFG());
         var2.RJF().setScale(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_taxController.fxml_component_main_element).getMaxLength());
         var2.RJF().setPresicion(((TextFieldValidated_Number)var1.fxml_other_purchase_new_add_other_element_taxController.fxml_component_main_element).getMaximumFractionDigits());
         this.RJV((QSI)null, (QSI)var2, QSV.NET);
   ...
   public void setInvoiceOtherSubType(QSQ var1) {
      ((ComboBoxRequired)this.fxml_other_purchase_new_other_element_typeController.fxml_component_main_element).setValue(var1);
   }
}
