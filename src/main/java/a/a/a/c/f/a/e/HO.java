...
public abstract class HO extends IJ implements Cloneable {
   ...
   public JR getGrossPriceForUnit() {
      if (this.QWO == null && this.AKC != null && this.AKH != null && this.AKH.getValue() != null) {
         ...
         if (!((KL)this.AKH.getValue()).DEQ()) {
            var3 = ((KL)this.AKH.getValue()).getRate().divide(new BigDecimal(100));
         }

         BigDecimal var4 = ((BigDecimal)this.AKC.getValue()).add(((BigDecimal)this.AKC.getValue()).multiply(var3)).setScale(var1, var2);
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         } else if (!this.QWP.equals(var2.QWP)) {
            return false;
         }
