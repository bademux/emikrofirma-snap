...
public class QSC implements QRX<QSH> {
   ...
   public QSH RIB(QSH var1, QSH var2) {
      ...
      BigDecimal var6;
      if (var3) {
         var6 = (BigDecimal)var2.RJE().getValue();
         var2.RJE().setValue(var6);
      }

      if (var4) {
         var6 = BigDecimal.ZERO;
         if (!((KL)var2.RJH().getValue()).DEQ()) {
            var6 = ((KL)var2.RJH().getValue()).getRate().divide(new BigDecimal(100)).setScale(EQY.FYD);
         }

         var6 = EQY.HRH((BigDecimal)var2.RJE().getValue(), var6);
         var2.RJF().setValue(var6);
      }

      if (var5) {
         var6 = BigDecimal.ZERO;
         BigDecimal var7 = (BigDecimal)var2.RJE().getValue();
         if (!((KL)var2.RJH().getValue()).DEQ()) {
            var6 = (BigDecimal)var2.RJF().getValue();
         }
