...
public class ViewDef extends View {
    private final boolean HDU;
    private final boolean HDV;
    private final List<CellNamed> HDW;
    private final String HDX;

    public ViewDef(boolean var1, String var2, String var3, boolean var4, List<CellNamed> var5, String var6) {
    ...
    public ViewDef(boolean var1, String var2, String var3, boolean var4, String var5) {
