...
import a.a.a.c.c.e.j.a.a.EUI;
import a.a.a.c.c.e.j.a.a.EUJ;
import a.a.a.c.c.e.j.a.a.EUK;
import a.a.a.c.c.e.j.a.a.EUL;
import a.a.a.c.c.e.j.a.a.EUM;
import a.a.a.c.c.e.j.a.a.EUN;
import a.a.a.c.c.e.j.a.a.EUO;
import a.a.a.c.c.e.j.a.a.EUP;
import a.a.a.c.c.e.j.a.a.EUQ;
import a.a.a.c.c.e.j.a.a.EUR;
import a.a.a.c.c.e.j.a.a.EUS;
import a.a.a.c.c.e.j.a.a.QKJ;
import a.a.a.c.c.e.j.a.a.QTM;
import a.a.a.c.c.e.j.a.a.ROY;
...
public class EUT extends EMD implements EMO<HO>, EYR {
   ...
   private ListProperty<HQ> GLY = new SimpleListProperty();
   private ListProperty<HQ> GLZ = new SimpleListProperty();
   ...
   public void initialize() {
      ...
      try {
         ...
         ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).setEditable(false);
         ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).setEditable(false);
         ((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).setEditable(false);
         ...
         ((TextFieldValidated_Text)this.fxml_invoice_sale_correct_ref_idController.fxml_component_main_element).setEditable(false);
         ((DatePickerRequired)this.fxml_invoice_sale_correct_creation_dateController.fxml_component_main_element).setDisable(true);
         ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).editableProperty().bind(this.GLT.and(this.QNH.not()));
         ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).disableProperty().bind(this.GLT.not().or(this.QNH));
         ((TextFieldValidated_Text)this.fxml_invoice_sale_creation_placeController.fxml_component_main_element).editableProperty().bind(this.GLR.not().and(this.GLT));
         ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).disableProperty().bind(this.GLR.or(this.GLT.not()));
         ((DatePickerRequired)this.fxml_invoice_sale_invoicing_dateController.fxml_component_main_element).disableProperty().bind(this.GLT.not());
         ((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).disableProperty().bind(this.GLR.not().and(this.GLT).not());
         ((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).disableProperty().bind(this.GLR.not().and(this.GLT).not());
         ((TextFieldValidated_Text)this.fxml_sale_contractor_streetController.fxml_component_main_element).editableProperty().bind(this.GLR.not().and(this.GLT));
         ((TextFieldValidated_Text)this.fxml_sale_contractor_house_numberController.fxml_component_main_element).editableProperty().bind(this.GLR.not().and(this.GLT));
         ((TextFieldValidated_Text)this.fxml_sale_contractor_apartment_numberController.fxml_component_main_element).editableProperty().bind(this.GLR.not().and(this.GLT));
         ((TextFieldValidated_PostalCode)this.fxml_sale_contractor_postal_codeController.fxml_component_main_element).editableProperty().bind(this.GLR.not().and(this.GLT));
         ((TextFieldValidated_Text)this.fxml_sale_contractor_cityController.fxml_component_main_element).editableProperty().bind(this.GLR.not().and(this.GLT));
         this.fxml_invoice_sale_elements_table.editableProperty().bind(this.GLT);
         ((ComboBoxRequired)this.fxml_invoice_sale_payment_typeController.fxml_component_main_element).disableProperty().bind(this.GLT.not());
         ((TextFieldValidated_Number)this.fxml_invoice_sale_paymentdatedaysController.fxml_component_main_element).disableProperty().bind(this.GLT.not().or(this.fxml_invoice_sale_creation_dateController.requiredAndValidProperty().not()));
         ((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).disableProperty().bind(this.GLT.not().or(this.fxml_invoice_sale_creation_dateController.requiredAndValidProperty().not()));
         ...
         ((TextAreaRequired)this.fxml_invoice_sale_correct_reasonController.fxml_component_main_element).editableProperty().bind(this.GLT);
         ...
         ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).editableProperty().bind(this.GLT);
         ((TextAreaRequired)this.fxml_invoice_sale_exempt_reasonController.fxml_component_main_element).editableProperty().bind(this.GLT);
         ...
         this.fxml_invoice_sale_summary_summary_table.refresh();
         ((ComboBoxRequired)this.fxml_invoice_sale_payment_typeController.fxml_component_main_element).setCellFactory(new EOQ());
         ((ComboBoxRequired)this.fxml_invoice_sale_payment_typeController.fxml_component_main_element).setButtonCell((ListCell)((ComboBoxRequired)this.fxml_invoice_sale_payment_typeController.fxml_component_main_element).getCellFactory().call(null));
         ((ComboBoxRequired)this.fxml_invoice_sale_payment_typeController.fxml_component_main_element).getItems().addAll(KI.values());
         ((ComboBoxRequired)this.fxml_invoice_sale_payment_typeController.fxml_component_main_element).setEditable(false);
         this.GLX.addListener(new EUK(this));
         ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).valueProperty().addListener(new EUM(this, this.resources));
         ((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).valueProperty().addListener(new EUQ(this));
         ((TextFieldValidated_Number)this.fxml_invoice_sale_paymentdatedaysController.fxml_component_main_element).textProperty().addListener(new EUI(this));
         ...
         ((DatePickerRequired)this.fxml_invoice_sale_invoicing_dateController.fxml_component_main_element).valueProperty().addListener(new EUR(this, this.resources));
         ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).textProperty().addListener(new EUN(this));
         ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).valueProperty().addListener(new EUJ(this, this.resources));
         ...
         ((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).getEditor().textProperty().addListener(new EUS(this));
   ...
   private void HXD() {
      ...
      try {
         ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).textProperty().bindBidirectional(this.GLN.DAS().DDG());
         ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).valueProperty().bindBidirectional(this.GLN.DAT().DEC());
         ...
         ((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).valueProperty().bindBidirectional(this.GLN.DAZ().DEC());
         ...
         ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).textProperty().bindBidirectional(this.GLN.DBB().DDG());
         ((TextAreaRequired)this.fxml_invoice_sale_exempt_reasonController.fxml_component_main_element).textProperty().bindBidirectional(this.GLN.QOQ().DDG());
         ((DatePickerRequired)this.fxml_invoice_sale_invoicing_dateController.fxml_component_main_element).valueProperty().bindBidirectional(this.GLN.IYZ().DEC());
         this.GLX.bindBidirectional(this.GLN.DAF().DDM());
         Iterator var1;
         if (!this.GLR.get()) {
            HU var8 = (HU)this.GLN;
            ((TextFieldValidated_Text)this.fxml_invoice_sale_creation_placeController.fxml_component_main_element).textProperty().bindBidirectional(var8.DBW().DDG());
            ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).valueProperty().bindBidirectional(var8.DAU().DEC());
         } else {
            ...
            if (this.GLM == EPB.CORRECT) {
               this.GLN.setMpp((Boolean)this.GLP.getMpp().getValue());
               ...
               if ((Boolean)this.GLP.getMpp().getValue()) {
                  ...
                  if (this.fxml_invoice_sale_remarksController != null && this.fxml_invoice_sale_remarksController.fxml_component_main_element != null) {
                     ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).setText(var6);
                  }
               }
            }
            ...
            ((TextAreaRequired)this.fxml_invoice_sale_correct_reasonController.fxml_component_main_element).textProperty().bindBidirectional(var7.DBX().DDG());
            ((TextFieldValidated_Text)this.fxml_invoice_sale_correct_ref_idController.fxml_component_main_element).textProperty().bindBidirectional(this.GLO.DAS().DDG());
            ((DatePickerRequired)this.fxml_invoice_sale_correct_creation_dateController.fxml_component_main_element).valueProperty().bindBidirectional(this.GLO.DAT().DEC());
            ((TextFieldValidated_Text)this.fxml_invoice_sale_creation_placeController.fxml_component_main_element).textProperty().bindBidirectional(this.GLO.DBW().DDG());
            ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).valueProperty().bindBidirectional(this.GLO.DAU().DEC());
         }
   ...
   private void initializeCalculationMethod() {
      if (this.GLM == EPB.NEW) {
         ...
         if (this.GLM != EPB.CORRECT && this.GLM != EPB.EDIT_CORRECTION && this.GLM != EPB.VIEW_CORRECTION) {
            ...
            var1 = ((QSV)this.GLN.RIE().getValue()).toString();
            if (var1.equals("NET")) {
            ...
            var1 = ((QSV)this.GLO.RIE().getValue()).toString();
            if (var1.equals("NET")) {
               this.fxml_invoice_sale_elements_table_column_price_before_correct.setCellValueFactory(new PropertyValueFactory("netPriceForUnit"));
            } else if (var1.equals("GROSS")) {
               this.fxml_invoice_sale_elements_table_column_price_before_correct.setCellValueFactory(new PropertyValueFactory("grossPriceForUnit"));
   ...
   public void RLB(String var1) {
      if (var1.equals("NET")) {
         this.fxml_invoice_sale_elements_table_column_price.setCellValueFactory((Callback)null);
         this.fxml_invoice_sale_elements_table_column_price.setCellValueFactory(new PropertyValueFactory("netPriceForUnit"));
      } else if (var1.equals("GROSS")) {
         this.fxml_invoice_sale_elements_table_column_price.setCellValueFactory((Callback)null);
         this.fxml_invoice_sale_elements_table_column_price.setCellValueFactory(new PropertyValueFactory("grossPriceForUnit"));
   ...
   public void RLC(String var1) {
      HQ var3;
      for(Iterator var2 = this.fxml_invoice_sale_elements_table.getItems().iterator(); var2.hasNext(); this.RJV((HO)null, (HO)var3, (QSV)null)) {
         var3 = (HQ)var2.next();
         if (var1.equals("NET")) {
   ...
   private void HXE() {
      ...
      try {
         this.HHD(((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).textProperty(), this.GLN.DAS().DDG());
         ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).valueProperty().unbindBidirectional(this.GLN.DAT().DEC());
         ...
         ((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).valueProperty().unbindBidirectional(this.GLN.DAZ().DEC());
         ...
         this.HHD(((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).textProperty(), this.GLN.DBB().DDG());
         this.HHD(((TextAreaRequired)this.fxml_invoice_sale_exempt_reasonController.fxml_component_main_element).textProperty(), this.GLN.QOQ().DDG());
         ((DatePickerRequired)this.fxml_invoice_sale_invoicing_dateController.fxml_component_main_element).valueProperty().bindBidirectional(this.GLN.IYZ().DEC());
         this.GLX.unbindBidirectional(this.GLN.DAF().DDM());
         if (!this.GLR.get()) {
            HU var1 = (HU)this.GLN;
            this.HHD(((TextFieldValidated_Text)this.fxml_invoice_sale_creation_placeController.fxml_component_main_element).textProperty(), var1.DBW().DDG());
         } else {
            ...
            this.HHD(((TextAreaRequired)this.fxml_invoice_sale_correct_reasonController.fxml_component_main_element).textProperty(), var5.DBX().DDG());
            this.HHD(((TextFieldValidated_Text)this.fxml_invoice_sale_correct_ref_idController.fxml_component_main_element).textProperty(), this.GLO.DAS().DDG());
            ((DatePickerRequired)this.fxml_invoice_sale_correct_creation_dateController.fxml_component_main_element).valueProperty().unbindBidirectional(this.GLO.DAT().DEC());
            this.HHD(((TextFieldValidated_Text)this.fxml_invoice_sale_creation_placeController.fxml_component_main_element).textProperty(), this.GLO.DBW().DDG());
            ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).valueProperty().unbindBidirectional(this.GLO.DAU().DEC());
         }
   ...
   private void HXF() {
      ...
      try {
         ...
         this.HHD(((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).getEditor().textProperty(), var1.DAI().DDG());
         this.HHD(((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).getEditor().textProperty(), var1.DAJ().DDG());
         JJ var6 = var1.DAM();
         this.HHD(((TextFieldValidated_Text)this.fxml_sale_contractor_streetController.fxml_component_main_element).textProperty(), var6.DDA().DDG());
         this.HHD(((TextFieldValidated_Text)this.fxml_sale_contractor_house_numberController.fxml_component_main_element).textProperty(), var6.DDB().DDG());
         this.HHD(((TextFieldValidated_Text)this.fxml_sale_contractor_apartment_numberController.fxml_component_main_element).textProperty(), var6.DDC().DDG());
         this.HHD(((TextFieldValidated_PostalCode)this.fxml_sale_contractor_postal_codeController.fxml_component_main_element).textProperty(), var6.DDD().DDG());
         this.HHD(((TextFieldValidated_Text)this.fxml_sale_contractor_cityController.fxml_component_main_element).textProperty(), var6.DCZ().DDG());
   ...
   private void HXG() {
      ...
      try {
         ...
         ((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).getEditor().textProperty().bindBidirectional(var1.DAI().DDG());
         ((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).getEditor().textProperty().bindBidirectional(var1.DAJ().DDG());
         JJ var6 = var1.DAM();
         ((TextFieldValidated_Text)this.fxml_sale_contractor_streetController.fxml_component_main_element).textProperty().bindBidirectional(var6.DDA().DDG());
         ((TextFieldValidated_Text)this.fxml_sale_contractor_house_numberController.fxml_component_main_element).textProperty().bindBidirectional(var6.DDB().DDG());
         ((TextFieldValidated_Text)this.fxml_sale_contractor_apartment_numberController.fxml_component_main_element).textProperty().bindBidirectional(var6.DDC().DDG());
         ((TextFieldValidated_PostalCode)this.fxml_sale_contractor_postal_codeController.fxml_component_main_element).textProperty().bindBidirectional(var6.DDD().DDG());
         ((TextFieldValidated_Text)this.fxml_sale_contractor_cityController.fxml_component_main_element).textProperty().bindBidirectional(var6.DCZ().DDG());
   ...
   private void setDefault() {
      ...
      try {
         ...
         if (!var1) {
            ((DatePickerRequired)this.fxml_invoice_sale_invoicing_dateController.fxml_component_main_element).setValue(LocalDate.now());
         }

         ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).setValue(LocalDate.now());
         ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).setValue(LocalDate.now());
         ((TextFieldValidated_Number)this.fxml_invoice_sale_paymentdatedaysController.fxml_component_main_element).setText("7");
         ((TextFieldValidated_Text)this.fxml_invoice_sale_creation_placeController.fxml_component_main_element).setText((String)this.GLL.getUserData().DFN().DCZ().getValue());
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   private void setDefaultCorrection() {
      ...
      try {
         ...
         while(true) {
            if (!var3.hasNext()) {
               if (var10 && this.GLP.QOQ().getValue() != null && ((String)this.GLP.QOQ().getValue()).length() > 0) {
                  ((TextAreaRequired)this.fxml_invoice_sale_exempt_reasonController.fxml_component_main_element).setText((String)this.GLP.QOQ().getValue());
               }
               break;
            }

            HQ var4 = (HQ)var3.next();
            if (((KL)var4.getTaxRate().getValue()).equals(KL.ZW)) {
               var10 = true;
            }
         }
      } finally {
   ...
   private void HXJ() {
      ...
      try {
         ...
         this.GMG = null;
         this.GMH = null;
         ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).setValue(null);
         ((DatePickerRequired)this.fxml_invoice_sale_transaction_dateController.fxml_component_main_element).setValue(null);
         ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).setText((String)null);
         this.fxml_sale_contractor_private_person.setSelected(false);
         ((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).getItems().clear();
         ((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).setValue(null);
         ((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).getItems().clear();
         ((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).setValue(null);
   ...
   public EUG HXK() throws IOException {
      ...
      try {
         ...
         var3.setScene(var4);
         EUG var5 = (EUG)var1.getController();
   ...
   public void HXL(EUG var1) {
      if (var1.HXC()) {
         ...
         var2.DBF().setValue(((TextAreaRequired)var1.fxml_invoice_sale_new_add_invoice_element_descriptionController.fxml_component_main_element).getText());
         ...
         var2.DBI().setValue(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).getNumber());
         var2.DBI().setAllowNegative(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).IFG());
         var2.DBI().setScale(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).getMaxLength());
         var2.DBI().setPresicion(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).getMaximumFractionDigits());
         ...
         var2.RIF().setValue(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).getNumber());
         var2.RIF().setAllowNegative(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).IFG());
         var2.RIF().setScale(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).getMaxLength());
         var2.RIF().setPresicion(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_netpriceController.fxml_component_main_element).getMaximumFractionDigits());
         var2.DBG().setValue(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_amountController.fxml_component_main_element).getNumber());
         var2.DBG().setAllowNegative(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_amountController.fxml_component_main_element).IFG());
         var2.DBG().setScale(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_amountController.fxml_component_main_element).getMaxLength());
         var2.DBG().setPresicion(((TextFieldValidated_Number)var1.fxml_invoice_sale_new_add_invoice_element_amountController.fxml_component_main_element).getMaximumFractionDigits());
         var2.DBH().setValue(((TextFieldValidated_Text)var1.fxml_invoice_sale_new_add_invoice_element_unitController.fxml_component_main_element).getText());
         ...
         this.RJV((HO)null, (HO)var2, (QSV)null);
         this.HJJ();
   ...
   private void QPI() {
      ...
      try {
         ...
         while(var2.hasNext()) {
            ...
            if (((KL)var3.getTaxRate().getValue()).equals(KL.ZW)) {
               var1 = true;
            }
         }
         ...
         if (var1) {
            ...
            ((TextAreaRequired)this.fxml_invoice_sale_exempt_reasonController.fxml_component_main_element).setText((String)null);
      ...
      try {
         ...
         if (this.GLN.getInvoiceElements() != null) {
            ...
            while(var2.hasNext()) {
               ...
               HQ var4 = (HQ)var3;
               if (var4.DBE().getValue() != null && ((String)var4.DBE().getValue()).trim().length() != 0) {
                  if (var4.DBH().getValue() != null && ((String)var4.DBH().getValue()).trim().length() != 0) {
   ...
   public void HJJ() {
      ...
      try {
         ...
         if (this.GLM.getCorrectFields()) {
            ...
            var11 = EQY.HRJ(var1, (BigDecimal)this.GLP.getAmountSummaryWithoutTax().getValue());
            var12 = EQY.HRJ(var2, (BigDecimal)this.GLP.getAmountTax().getValue());
            var6 = EQY.HRJ(var3, (BigDecimal)this.GLP.getAmountSummaryWithTax().getValue());
            HV var7 = (HV)this.GLN;
   ...
   private void HXN() {
      ...
      try {
         ...
         while(var2.hasNext()) {
            HQ var3 = (HQ)var2.next();
            if (((KL)var3.getTaxRate().getValue()).DEQ()) {
               var1 = true;
               break;
            }
         }
         ...
         boolean var7 = false;
         if (((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).getText() != null && ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).getText().contains(this.resources.getString("micro.process.invoice_sale_new.Remarks.Inverse"))) {
            var7 = true;
         }

         if (var1 && !var7) {
            String var8 = "";
            if (((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).getText() != null) {
               var8 = ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).getText();
            }

            ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).setText(this.resources.getString("micro.process.invoice_sale_new.Remarks.Inverse") + var8);
         } else if (!var1 && var7 && ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).getText() != null) {
            ((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).setText(((TextAreaRequired)this.fxml_invoice_sale_remarksController.fxml_component_main_element).getText().replaceAll(this.resources.getString("micro.process.invoice_sale_new.Remarks.Inverse"), ""));
         }
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public void HXO() {
      ...
      try {
         if (((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).getValue() != null && this.fxml_invoice_sale_creation_dateController.requiredAndValidProperty().get() && ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).getValue() != null) {
            long var1 = ((LocalDate)((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).getValue()).toEpochDay() - ((LocalDate)((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).getValue()).toEpochDay();
            ((TextFieldValidated_Number)this.fxml_invoice_sale_paymentdatedaysController.fxml_component_main_element).setText(String.valueOf(var1));
         }
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public void HXP() {
      ...
      try {
         Integer var1 = null;
         if (((TextFieldValidated_Number)this.fxml_invoice_sale_paymentdatedaysController.fxml_component_main_element).getText() != null) {
            try {
               var1 = Integer.valueOf(((TextFieldValidated_Number)this.fxml_invoice_sale_paymentdatedaysController.fxml_component_main_element).getText().replace(String.valueOf(this.GLQ.getGroupingSep()), ""));
         ...
         if (var1 != null) {
            if (this.fxml_invoice_sale_creation_dateController.requiredAndValidProperty().get() && ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).getValue() != null) {
               ((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).setValue(((LocalDate)((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).getValue()).plusDays((long)var1));
            }
         } else {
            ((DatePickerRequired)this.fxml_invoice_sale_paymentdateController.fxml_component_main_element).setValue(null);
         }
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   private void HXR() {
      ...
      try {
         if (((DatePickerRequired)this.fxml_invoice_sale_invoicing_dateController.fxml_component_main_element).getValue() != null && this.fxml_invoice_sale_invoicing_dateController.requiredAndValidProperty().get()) {
            this.GLX.set(new JN(Date.from(((LocalDate)((DatePickerRequired)this.fxml_invoice_sale_invoicing_dateController.fxml_component_main_element).getValue()).atStartOfDay(ZoneId.systemDefault()).toInstant())));
   ...
   public void HXS() {
      ...
      try {
         ...
         if (this.GLL != null && ((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).getValue() != null && this.fxml_invoice_sale_creation_dateController.requiredAndValidProperty().get()) {
            String var1 = this.GLL.getRefId((LocalDate)((DatePickerRequired)this.fxml_invoice_sale_creation_dateController.fxml_component_main_element).getValue());
            ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).setText(var1);
         }
      } catch (FFK var5) {
         EXF.getInstance().ICA((Throwable)var5);
      } finally {
      ...
      try {
         ...
         while(true) {
            if (var2 < this.GLN.getInvoiceElements().size()) {
               if (((HQ)this.GLP.getInvoiceElements().get(var2)).DBH().compareTo(((HQ)this.GLN.getInvoiceElements().get(var2)).DBH()) != 0) {
                  var1 = false;
               } else if (!ERF.HSA(((HQ)this.GLP.getInvoiceElements().get(var2)).DBI(), ((HQ)this.GLN.getInvoiceElements().get(var2)).DBI())) {
                  var1 = false;
               } else if (!ERF.HSA(((HQ)this.GLP.getInvoiceElements().get(var2)).DBG(), ((HQ)this.GLN.getInvoiceElements().get(var2)).DBG())) {
                  var1 = false;
               } else if (((HQ)this.GLP.getInvoiceElements().get(var2)).DBN().getValue() != ((HQ)this.GLN.getInvoiceElements().get(var2)).DBN().getValue()) {
                  var1 = false;
               } else if (((HQ)this.GLP.getInvoiceElements().get(var2)).DBK().compareTo(((HQ)this.GLN.getInvoiceElements().get(var2)).DBK()) != 0) {
                  var1 = false;
               } else if (!ERF.HSA(((HQ)this.GLP.getInvoiceElements().get(var2)).DBL(), ((HQ)this.GLN.getInvoiceElements().get(var2)).DBL())) {
                  var1 = false;
               } else {
                  if (ERF.HSA(((HQ)this.GLP.getInvoiceElements().get(var2)).DBM(), ((HQ)this.GLN.getInvoiceElements().get(var2)).DBM())) {
                     ++var2;
                     continue;
                  }
   ...
   public void setContractorFromAutocomplete(QJW var1) {
      ...
      try {
         if (var1 != null) {
            ...
            ((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).getEditor().setText((String)var2.getNip().getValue());
            ((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).getEditor().positionCaret(((ComboBoxValidated_NIP)this.fxml_sale_contractor_nipController.fxml_component_main_element).getEditor().getText().length());
            ((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).getEditor().setText((String)var2.getName().getValue());
            ((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).getEditor().positionCaret(((ComboBoxValidated_ContractorName)this.fxml_sale_contractor_nameController.fxml_component_main_element).getEditor().getText().length());
            JJ var3 = var2.DAM();
            ((TextFieldValidated_Text)this.fxml_sale_contractor_streetController.fxml_component_main_element).setText((String)var3.getStreet().getValue());
            ((TextFieldValidated_Text)this.fxml_sale_contractor_house_numberController.fxml_component_main_element).setText((String)var3.getHouseNumber().getValue());
            ((TextFieldValidated_Text)this.fxml_sale_contractor_apartment_numberController.fxml_component_main_element).setText((String)var3.getApartmentNumber().getValue());
            ((TextFieldValidated_PostalCode)this.fxml_sale_contractor_postal_codeController.fxml_component_main_element).setText((String)var3.getPostalCode().getValue());
            ((TextFieldValidated_Text)this.fxml_sale_contractor_cityController.fxml_component_main_element).setText((String)var3.getCity().getValue());
         }
      } finally {
         EXF.getInstance().ICP();
      }
   ...
   public void QGQ(String var1) {
      ...
      try {
         if (var1 == null) {
            var1 = ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).getText();
         }

         ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).IEW().set(true);
         boolean var2 = false;
         if (this.QGI != null && this.GLX.get() != null && !this.QGI.equals(this.GLX.get())) {
            var2 = true;
         }
         ...
         try {
            var3 = this.GLL.HYB((JN)this.GLX.get(), ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).getText());
         } catch (FFO | FFK var8) {
            EXF.getInstance().ICA((Throwable)var8);
         }

         if (this.GLM != EPB.EDIT && this.GLM != EPB.EDIT_CORRECTION && !var3) {
            ((TextFieldValidated_Text)this.fxml_invoice_sale_ref_idController.fxml_component_main_element).IEW().set(false);
