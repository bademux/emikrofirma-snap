...
public class EUY extends ELX implements EYL {
   ...
   public HU getInvoiceSell(HI var1) throws FFK, FFO {
      ...
      try {
         if (this.GMW == null) {
            this.GMW = (HU)this.getModelManager().HJX(this.getParentDefinition(), HU.class);
            if (var1 != null) {
   ...
   public HV getInvoiceSellCorrection() throws FFK, FFO {
      ...
      try {
         if (this.GMX == null) {
            this.GMX = (HV)this.getModelManager().HJX(this.getParentDefinition(), HV.class);
         }
   ...
   public String getRefId(LocalDate var1) throws FFK {
      ...
      try {
         ...
         if (this.GMY != EPB.CORRECT && this.GMY != EPB.EDIT_CORRECTION) {
            var2 = (String)this.GMT.DEY().getValue();
         } else {
            var2 = (String)this.GMU.DEY().getValue();
         }
   ...
   public File getWorkingDir() {
      ...
      File var2;
      try {
         File var1 = new File((String)this.GMV.DEY().getValue());
         var1.mkdirs();
         var2 = var1;
      } finally {
         EXF.getInstance().ICP();
